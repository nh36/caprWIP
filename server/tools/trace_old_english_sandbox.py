...
STAGES: Sequence[Tuple[str, str]] = [
    ...
    ("ShortAFronting", "old_english_sandbox_after_short_a_fronting.bin"),
    ("ProtoRhoticFronting", "old_english_sandbox_after_proto_rhotic_fronting.bin"),
    ("RhoticBreaking", "old_english_sandbox_after_rhotic_breaking.bin"),
    ("ShortBackLowering", "old_english_sandbox_after_short_back_lowering.bin"),
    ("ShortVowelSplit", "old_english_sandbox_after_short_vowel_split.bin"),
    ("RhoticColoring", "old_english_sandbox_after_rhotic_coloring.bin"),
    ("VowelRules", "old_english_sandbox_after_vowel_rules.bin"),
    ("PostVocalicRLoss", "old_english_sandbox_after_postvocalic_r_loss.bin"),
    ("WeakTailReductions", "old_english_sandbox_after_weak_tail.bin"),
    ("WeakTailCleanup", "old_english_sandbox_after_weak_tail_cleanup.bin"),
    ("SilentInitialCleanup", "old_english_sandbox_after_silent_cleanup.bin"),
    ("GhDeletion", "old_english_sandbox_after_gh_deletion.bin"),
    ("Orthography", "old_english_sandbox_after_orthography.bin"),
    ("LongVowelRealisation", "old_english_sandbox_after_long_vowel_realisation.bin"),
