...
STAGES=(GermanAfterEw GermanAfterAu GermanAfterLongV GermanAfterNasal GermanAfterConsonant GermanAfterStopShift GermanAfterStarDrop GermanAfterVowelAdj GermanAfterCleanup GermanPreSurface)
