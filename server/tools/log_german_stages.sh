...
STAGES=(GermanAfterEw GermanAfterAu GermanAfterLongV GermanAfterNasal GermanAfterConsonant GermanAfterStopShift GermanAfterAzLoss GermanAfterStarDrop GermanAfterVowelAdj GermanAfterCleanup GermanPreSurface)
