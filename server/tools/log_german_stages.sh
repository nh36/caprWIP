...
STAGES=(GermanAfterEw GermanAfterAu GermanAfterLongV GermanAfterStarDrop GermanAfterNasal GermanAfterShift GermanAfterVowelAdj GermanAfterCleanup GermanPreSurface)
