...
STAGES=(GermanAfterEw GermanAfterLongV GermanAfterAu GermanAfterNasal GermanAfterConsonant GermanAfterStopShift GermanAfterAzLoss GermanAfterVowelAdj GermanAfterFinalDevoice GermanAfterCleanup GermanAfterOrthography GermanAfterStarDrop GermanPreSurface)
