# Reader-facing manifest coverage 01

## Inputs

1. `Germanic/docs/sound_changes/change_reports/report_manifest.tsv`
2. `Germanic/docs/sound_changes/reader_facing/build_reader_facing_local_section_14_docker.sh`
...
## SC001-SC013 and the current manifest-backed programme

1. `SC001-SC013` are outside the current manifest-backed reader-facing programme because `report_manifest.tsv` begins at `SC014-SC015`.
