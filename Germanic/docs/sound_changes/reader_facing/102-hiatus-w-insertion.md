...
Þórhallsdóttir's study of the class shows where the glide arose regularly: first between the stem vowel and the \emph{*u}-initial endings — present indicative first singular \emph{*-u}, past indicative plural \emph{*-un} — and from there it was generalized through the rest of the paradigm [@Thorhallsdottir1993, pp. 114--137], as cited by Ringe and Taylor [@RingeTaylor2014, p. 151]. The rule below models the outcome of that generalization on citation forms; the layering of regular insertion and analogical spread is part of the historical record, not of the executable statement.
