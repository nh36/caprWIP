...
a separate law [@HoggPhonology1992, p. 113].
...
@HoggPhonology1992, p. 113]. The formal rule is therefore narrower than the total set of
...
@HoggPhonology1992, p. 113]. Without an explicit rule, those outcomes would be left to
...
# Reader-facing pilot 02 source note
...
## New chapter source files consulted
...
Pilot 02 keeps the original three chapters unchanged and extends the tested
reader-facing layer by a small adjacent batch around them. It is still a local
proof of method rather than a full conversion of the manifest-backed sound-change
reports.
