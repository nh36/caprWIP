...
`SC005`, `SC009`, `SC012`, `SC038`, `SC062`, `SC077`, `SC084`
...
3. `SC006` is now covered by `006-early-i-apocope.md`.
4. `SC007` is now covered by `007-final-o-lowering-before-r.md`.
5. `SC008` is now covered by `008-coronal-w-assimilation.md`.
6. `SC010` is now covered by `010-west-germanic-j-gemination.md`.
7. `SC011` is now covered by `011-syllabic-j-after-final-vowel-loss.md`.
8. `SC013` is now covered by `013-dental-hardening.md`.
9. `SC005` is absent because `report_manifest.tsv` does not include it.
10. `SC009` is absent because `report_manifest.tsv` does not include it.
11. `SC012` is absent because `report_manifest.tsv` does not include it.
12. Coverage from `SC014` through `SC087` remains intact.
13. The remaining early SC numbers outside the current manifest-backed programme are `SC001`, `SC002`.
14. The manifest-backed sequence now opens with `SC003`, `SC004`, `SC006`, `SC007`, `SC008`, `SC010`, `SC011`, and `SC013`, and then resumes at `SC014-SC015`.
