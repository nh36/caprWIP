...
assembled_md="${script_dir}/reader_facing_local_section_12.md"
assembled_pdf="${script_dir}/reader_facing_local_section_12.pdf"
...
python3 Germanic/docs/sound_changes/reader_facing/check_reader_facing_section_order.py \
  --build-script Germanic/docs/sound_changes/reader_facing/build_reader_facing_local_section_12_docker.sh
...
out = root / "reader_facing_local_section_12.md"
chapter_files = [
...
docker run --rm --platform "${platform}" --entrypoint /bin/sh \
  -v "${repo_root}":/data -w /data "${image}" -c "
    ...
    pandoc Germanic/docs/sound_changes/reader_facing/reader_facing_local_section_12.md \
      --standalone \
      ...
      --citeproc \
      --pdf-engine=xelatex \
      -o Germanic/docs/sound_changes/reader_facing/reader_facing_local_section_12.pdf
  "
