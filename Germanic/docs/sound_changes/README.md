...
- `registry/sc_registry.tsv` `cascade_position` column — DERIVED from the
  executable model via `Germanic/tools/sync_registry_cascade_positions.py`
  (never hand-edited; the rest of the registry is SOURCE).
