...
assembled units: one pilot production report (`016-020`), three full
production reports (`026-027`, `043`, and `063`), and 15 remaining scaffold
placeholders. The paired SC026-SC027 promotion now complements the earlier
singleton promotions, while most other units remain intentionally grouped
