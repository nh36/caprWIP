# Evidence packet — 2297 wold / weald
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2297 | wold | weald | *wálθuz | *wálθuz | regular | Kroonen p.572 *walθu- > OE weald; wald is Anglian (R/T p.313 WS wealdan vs Merc. waldan) | - |
...
#### Germanic/docs/DEV_NOTES.md:30639 (exact pair)
...
30640: 
30641: The only TSV row that has the **exact shape** *\*[stressed *a*] + obstruent +
```
...
#### Germanic/docs/analysis/arestoration_r_l_research.md:747 (exact COUNTERPART)

- Nearby heading: ## 11. Affected TSV rows

```text
746: | 2289 | `*wáldaną` | `wealdan` | breaking |
747: | 2297 | `*wálþuz` | `weald` | breaking |
748: 
```
...
| :--- | :--- | :--- | :--- | :--- |
| wold | wald | inh | template:inh | wold |
