# Evidence packet — 2088 lade / hladan
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2088 | lade | hladan | *laθōjaną | *xláðaną | early_analogy | Wiktionary: PGmc *hlaðaną (Verner) > OE hladan \| Proto encoding: -aną (full vowel) for A-restoration; R/T §6.3.1 | - |
...
#### Germanic/docs/DEV_NOTES.md:10227 (row ID)

- Nearby heading: ### Analysis: `*xlaθaną` → `hladan`

```text
10225: ### Analysis: `*xlaθaną` → `hladan`
10226: 
10227: **TSV row 2088:**
10228: - PROTOFORM: `*xlaθaną` (voiceless `*θ`)
10229: - COUNTERPART: `hladan` (voiced `d`)
```
...
#### Germanic/docs/DEV_NOTES.md:10225 (exact COUNTERPART)

- Nearby heading: ### Analysis: `*xlaθaną` → `hladan`

```text
10223: - `*z` → OE `r` (rhotacism, earlier change)
10224: 
10225: ### Analysis: `*xlaθaną` → `hladan`
10226: 
10227: **TSV row 2088:**
...
#### Germanic/docs/DEV_NOTES.md:10229 (exact COUNTERPART)
...
10228: - PROTOFORM: `*xlaθaną` (voiceless `*θ`)
10229: - COUNTERPART: `hladan` (voiced `d`)
10230: - NOTE: "Wiktionary: PGmc *hlaθaną > OE hladan"
10231: 
```

#### Germanic/docs/DEV_NOTES.md:10230 (exact COUNTERPART)
...
10230: - NOTE: "Wiktionary: PGmc *hlaθaną > OE hladan"
10231: 
10232: **Problem:** If PGmc had voiceless `*θ`, OE would have `þ` (as in `baþan` "to bathe").
```

#### Germanic/docs/DEV_NOTES.md:10233 (exact COUNTERPART)
...
10231: 
10232: **Problem:** If PGmc had voiceless `*θ`, OE would have `þ` (as in `baþan` "to bathe").
10233: The OE form `hladan` with `d` shows Verner's Law applied.
10234: 
10235: **Kroonen (s.v. *hlaþan-):** Confirms OE `hladan` with `d`. The entry shows the
```

#### Germanic/docs/DEV_NOTES.md:10235 (exact COUNTERPART)
...
10234: 
10235: **Kroonen (s.v. *hlaþan-):** Confirms OE `hladan` with `d`. The entry shows the
10236: verb is Class VI strong (inf. `hladan`, past sg. `hlōd`, past pl. `hlōdon`, ptp. `hladen`).
10237: Verner alternation is expected in Class VI infinitives.
```

#### Germanic/docs/DEV_NOTES.md:10236 (exact COUNTERPART)
...
| :--- | :--- | :--- | :--- | :--- |
| lade | hladan | inh | template:inh | lade |
...
#### Germanic/docs/DEV_NOTES.md:10258 (concept name)
