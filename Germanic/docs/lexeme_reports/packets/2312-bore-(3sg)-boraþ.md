# Evidence packet — 2312 bore (3sg) / boraþ
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2312 | bore (3sg) | boraþ | *burōną | *búrōθi | late_analogy | Class II weak 3sg pres. indic. Regular: *-ōθi → -aþ (Campbell §355.4). No i-umlaut: 3sg ending never had -j-. Forms with -eþ are dialectal. | - |
...
#### Germanic/docs/DEV_NOTES.md:19572 (exact pair)
...
#### Germanic/docs/DEV_NOTES.md:19599 (row ID)
...
19601: | 2316 | `licceþ` | `liccaþ` | Regular *ōθi → -aþ. |
```

#### Germanic/docs/DEV_NOTES.md:19710 (exact pair)
...
#### Germanic/docs/DEV_NOTES.md:19953 (exact pair)
...
19955: 4. `*líznōθi → liornaþ` (currently produces `liorneþ`)
```
...
#### Germanic/docs/DEV_NOTES.md:19389 (exact PROTOFORM)
...
19391: | `*líkkōθi` | `liccoþ` | `licceþ` | `-o-` not `-e-` |
```

#### Germanic/docs/DEV_NOTES.md:19912 (exact PROTOFORM)
...
19914: | `*násō` | `*nasu` | This form worked because final `*ō` → `*u` first (different path) |
```
...
#### Germanic/docs/DEV_NOTES.md:19984 (exact pair)
...
19986: - `*líznōθi → liorneþ` (expected `liornaþ`)
```
