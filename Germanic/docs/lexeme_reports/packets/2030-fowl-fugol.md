# Evidence packet — 2030 fowl / fugol
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2030 | fowl | fugol | *fúglaz | *fúglaz | unexplained_unmodelled | DOCUMENTED EXCEPTION (per §17.10.34): Campbell §115 names fugol as exception to a-umlaut (regular outcome = **fogol, cf. OHG fogal). No lautgesetzlich PROTOFORM available: every paradigm cell with low *a/*ō triggers a-umlaut, every cell with high *i triggers i-umlaut; attested fugol is doubly irregular. | - |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| *fúglaz | wontfix | u_lowering_near_labial | Same u-lowering near labials issue (R/T vol.2 §2.3.1 explicit example) | notable_findings#2 | 2026-04-25 |

### DEV_NOTES hits

#### Germanic/docs/DEV_NOTES.md:1429 (exact pair)
...
#### Germanic/docs/DEV_NOTES.md:25950 (exact pair)
...
#### Germanic/docs/DEV_NOTES.md:26053 (row ID)
...
#### Germanic/docs/DEV_NOTES.md:30619 (row ID)
...
#### Germanic/docs/DEV_NOTES.md:74 (exact COUNTERPART)
...
#### Germanic/docs/DEV_NOTES.md:140 (exact COUNTERPART)
...
#### Germanic/docs/DEV_NOTES.md:2973 (exact COUNTERPART)

- Nearby heading: #### A. u-lowering (u → o before back vowel)

```text
2971: **Issue:** NWGmcULowering should lower *u → *o before non-high vowels in a following syllable. But these n-stem nominatives with {*ô} suffix retain u. The same problem exists for related words in the `vowel_quality__u_o_alternation` bucket.
2972: 
2973: **Note:** Some u-retentions are documented exceptions (bucc, fugol, wulf — see DEV_NOTES §1 above). But buga/boga, fula/fola are different: the expected form IS the lowered one (boga, fola), so u-retention here is a FST bug, not a documented exception.
2974: 
2975: #### B. Stressed vowel ie vs eo (*liznô → lierna vs leorna)
```
...
#### Germanic/docs/DEV_NOTES.md:16688 (exact COUNTERPART)
...
#### Germanic/docs/analysis/notable_findings.md:309 (exact COUNTERPART)

- Nearby heading: ## 2. NWGmc u-lowering exceptions near labials: a non-Neogrammarian pattern

```text
308: zwischen Labial und langem oder gedecktem l" ('especially between a
309: labial and long or covered l'): full, wulle, wulf, fugol, bucca, murcnian,
310: murnan. But he concedes that the regular outcome is o in the same
```

#### Germanic/docs/analysis/notable_findings.md:371 (exact COUNTERPART)

- Nearby heading: ## 2. NWGmc u-lowering exceptions near labials: a non-Neogrammarian pattern

```text
370: preserved u, very often where other West Gmc. languages, especially OHG,
371: have o, e.g. full full, fugol bird, bucca buck, wulf wolf, ufan from above,
372: OHG foll, fogal, boch, wolf, obana." Campbell then adds a detail others
```
...
| :--- | :--- | :--- | :--- | :--- |
| fowl | fugol | inh | template:inh | fowl |
...
#### Germanic/docs/DEV_NOTES.md:31320 (concept name)

- Nearby heading: ##### §17.19.10.2.e Comparison with parallel l-stems

```text
31318: | 'navel'       | *nablan-           | *nabulō       | *nab(u)lōn-     | disputed            |
31319: | 'nail'        | *naglaz            | *naglaz       | *nag(a)laz      | inherited *gl       |
31320: | 'fowl, bird'  | *fuglaz            | *fuglaz       | *fug(a)laz      | Sekundär vowel      |
31321: | 'apple'       | *aplu-/*apl-       | *applu        | *ap(a)laz       | Sekundär (EWA)      |
31322: | 'pillar'      | *stapulaz          | *stapulaz     | *stap(u)laz     | inherited (Kroonen has *u in headword) |
```
