# Evidence packet — 2266 wade / wadan
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2266 | wade | wadan | *wádaną | *wádaną | regular | Proto encoding: -aną (full vowel) for A-restoration; R/T §6.3.1 | Source: Wiktionary etymology (template:inh) \| Source: Wiktionary etymology (template:inh) |
...
#### Germanic/docs/DEV_NOTES.md:9502 (exact COUNTERPART)
...
#### Germanic/docs/DEV_NOTES.md:9510 (exact COUNTERPART)
...
#### Germanic/docs/DEV_NOTES.md:10090 (exact COUNTERPART)
...
10092: - `*þwahaną` → `þwēan` ✓ (was `þwæhan`)
```
...
| :--- | :--- | :--- | :--- | :--- |
| wade | wadan | inh | template:inh | wade |
