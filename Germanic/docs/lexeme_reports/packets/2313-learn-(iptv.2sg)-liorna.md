# Evidence packet — 2313 learn (iptv.2sg) / liorna
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2313 | learn (iptv.2sg) | liorna | *liznōjaną | *líznô | late_analogy | Northumbrian iptv.2sg. Uses io from regular breaking; WS leorna has leveled eo. | - |
...
#### Germanic/docs/DEV_NOTES.md:14832 (row ID)

- Nearby heading: ### Recommendation

```text
14830: **For the TSV entries:**
14831: - Row 2095: Change `*liznōjăną` to `*leznōną` (infinitive)
14832: - Row 2313: Change `*liznô` to `*leznō` (iptv.2sg uses stem + `*-ō`)
14833: - Row 2314: Change `*liznōθi` to `*leznōθi` (3sg has `*-θi`, still no `*j`)
14834: 
```

#### Germanic/docs/DEV_NOTES.md:14853 (row ID)

- Nearby heading: ### Solution (2026-04-07)

```text
14851: |-----|-----------|-----------|--------|
14852: | 2095 | `*liznōjăną` | `*leznōjăną` | leornian |
14853: | 2313 | `*liznô` | `*leznô` | leorna |
14854: | 2314 | `*liznōθi` | `*leznōθi` | leorneþ |
14855: 
```
...
#### Germanic/docs/analysis/notable_findings.md:1494 (note keyword: breaking)

- Nearby heading: ## 10. OE rēc 'smoke': the missing WS rīec problem

```text
1493: cognate that unambiguously requires PGmc *raukiz with i-trigger; ON
1494: breaking + i-umlaut of *au yields ey regularly. The continental WGmc
1495: cognates are mixed:
```

#### Germanic/docs/analysis/notable_findings.md:1621 (note keyword: breaking)

- Nearby heading: ### The two pathways

```text
1620: 
1621: **Pathway A — rhotacism + breaking (yields *meord*).**
1622: - *mizdō → *mizd*- (final-syllable apocope)
```
