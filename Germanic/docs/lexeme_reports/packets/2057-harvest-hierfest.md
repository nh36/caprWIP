# Evidence packet — 2057 harvest / hierfest
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2057 | harvest | hierfest | *xárbistuz | *xárbistuz | regular | R/T 14594-14603: hærfest is Anglian loan (Bammesberger 1997); WS hierfest attested (Toller); regular PGmc *harbistuz > WS hierfest via AFB+breaking+i-umlaut | - |
...
#### Germanic/docs/DEV_NOTES.md:38379 (exact pair)
...
38381: | `*strángiz`      | `strenġ`   | *e + *ng + palatal (no restoration) |
```
...
#### Germanic/docs/DEV_NOTES.md:6585 (exact COUNTERPART)

- Nearby heading: ## OE hierfest 'harvest' — Unstressed Front Vowel Merger

```text
6583: ---
6584: 
6585: ## OE hierfest 'harvest' — Unstressed Front Vowel Merger
6586: 
6587: **Date:** 2026-03-10 (completed 2026-03-11)
```

#### Germanic/docs/DEV_NOTES.md:6588 (exact COUNTERPART)
...
6586: 
6587: **Date:** 2026-03-10 (completed 2026-03-11)
6588: **Mismatch:** `*xarbistuz` → FST `hierfist` | Expected `hierfest`
6589: **Issue:** FST lacks the late OE unstressed `*i > *e` merger
6590: **Status:** ✅ FIXED — `OEUnstressedIMarking` + `OEMedUnstressedILowering` implemented
```

#### Germanic/docs/DEV_NOTES.md:6595 (exact COUNTERPART)

- Nearby heading: ### The Problem

```text
6593: 
6594: The FST produces `hierfist` with `-ist-` in the second syllable, but the TSV
6595: expects `hierfest` with `-est-`. The question is: what sound change converts
6596: medial `*-ist-` to `-est-`?
6597: 
```

#### Germanic/docs/DEV_NOTES.md:6632 (exact COUNTERPART)

- Nearby heading: #### 1. Early Stressed/Root-Initial *i > *e (Very Limited)

```text
6630: it applies "only" to `nest` and `wer`.
6631: 
6632: This is NOT the change relevant to `hierfest`.
6633: 
6634: #### 2. Late OE Unstressed Front Vowel Merger (General)
```

#### Germanic/docs/DEV_NOTES.md:6659 (exact COUNTERPART)

- Nearby heading: #### 2. Late OE Unstressed Front Vowel Merger (General)

```text
6657: > -ig < *-ig."
6658: 
6659: THIS is the change relevant to `hierfest`. It is:
6660: - **Late**: occurring around 700 AD, AFTER i-umlaut
6661: - **General**: affecting ALL unstressed front vowels, not just `*i`
```

#### Germanic/docs/DEV_NOTES.md:6674 (exact COUNTERPART)

- Nearby heading: ### The Full Development Path for WS *hierfest

```text
6672: - **OS**: Variable (forms with both `-i-` and `-e-`)
6673: 
6674: ### The Full Development Path for WS *hierfest
6675: 
6676: Given PGmc `*harbistaz`, the native WS development is:
```
...
#### Germanic/docs/analysis/fryhtu_investigation.md:201 (exact COUNTERPART)

- Nearby heading: ### What our FST implementation revealed

```text
200: | \*wīθijaz | wīþ | wīþeġ | \*i before \*j deleted (pre-existing mismatch worsened) |
201: | \*xarbistuz | +? | hierfest | \*i before \*s deleted → impossible cluster → crash |
202: 
```

#### Germanic/docs/analysis/fryhtu_investigation.md:227 (exact COUNTERPART)
...
#### Germanic/docs/analysis/fryhtu_investigation.md:286 (exact COUNTERPART)

- Nearby heading: ### Pipeline implementation

```text
285: - Syncopates all \*iθō-abstracts: strangiθō → strenġþu, furxtiθō → fyrhtu ✓
286: - Preserves þistel, wīþeġ, hierfest, sċiellen ✓
287: - Can be broadened to include \*r when comparatives are added to the pipeline
```
...
| :--- | :--- | :--- | :--- | :--- |
| harvest | hærfest | inh | template:inh | harvest |
...
#### Germanic/docs/DEV_NOTES.md:6604 (concept name)

- Nearby heading: ### Etymology: PGmc Had *i

```text
6602: **Kroonen (2013) p.210:**
6603: > "*harbista- m. 'autumn, fall' — ON haustr m. 'id.', ... OE herfest m.
6604: > 'harvest, autumn', ... OHG herbist m. 'harvest; autumn'"
6605: 
6606: **Orel (2003) p.161:**
```

#### Germanic/docs/DEV_NOTES.md:6608 (concept name)

- Nearby heading: ### Etymology: PGmc Had *i

```text
6606: **Orel (2003) p.161:**
6607: > "*xarbistuz ~ *xarbustuz sb.m.: ON haust 'autumn' (neut.), OE hærfest
6608: > 'harvest, autumn', OFris herfst id., OHG herbist id."
6609: 
6610: **Bammesberger (1997) p.223:**
```

#### Germanic/docs/DEV_NOTES.md:6859 (concept name)
...
6857: **Example traces:**
6858: 
6859: 1. `*harbistuz` (harvest):
6860:    - Input: `*h*a*r*b*i*s*t*u*z`
6861:    - After Step 2: unchanged (no prefix)
```
...
#### Germanic/docs/analysis/arestoration_r_l_research.md:735 (exact pair)
...
| :--- | :--- |
| Bammesberger1997 | author + year mention (Bammesberger 1997) |
...
| Bammesberger1990 | surname mention only: Bammesberger |
