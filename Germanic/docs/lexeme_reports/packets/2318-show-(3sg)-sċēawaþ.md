# Evidence packet — 2318 show (3sg) / sċēawaþ
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2318 | show (3sg) | sċēawaþ | *skawōną | *skáwōθi | late_analogy | Class II weak 3sg pres. indic. Regular: *-ōθi → -aþ. No i-umlaut: 3sg ending never had -j-. Normalized sċ: Campbell §440. | - |
...
#### Germanic/docs/DEV_NOTES.md:19392 (exact PROTOFORM)
...
19392: | `*skáwōθi` | `sċēawoþ` | `sċēaweþ` | `-o-` not `-e-` |
19393: 
19394: ### The Phonological Analysis
```

#### Germanic/docs/DEV_NOTES.md:19602 (exact COUNTERPART)
...
19602: | 2318 | `sċēaweþ` | `sċēawaþ` | Regular *ōθi → -aþ. |
19603: 
19604: ### References
```
...
#### Germanic/docs/DEV_NOTES.md:26639 (exact pair)
