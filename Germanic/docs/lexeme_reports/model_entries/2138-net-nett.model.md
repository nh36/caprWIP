...
| :--- | :--- |
| lexical item | net |
| citation reconstruction / lexeme label | *natjan |
| selected input form | *nátją |
| Old English target | nett |
| classification | regular |
| documented output | *nátją -> nett |
...
Spellings in `net` can therefore be graphic simplifications, but the lexical target supported by the dictionary evidence is `nett` [@Campbell1959; @Orel2003].
