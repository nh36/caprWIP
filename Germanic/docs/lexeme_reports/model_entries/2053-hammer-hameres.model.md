...
| :--- | :--- |
| lexical item | hammer |
| citation reconstruction / lexeme label | *xámaraz |
| selected input form | *xámaras |
| Old English target | hameres |
| classification | late_analogy |
| documented output | *xámaras -> hameres |
...
unstressed `æ` 'hammer' with `e` yield [`hameres`]{.iv lang=oe sort=hameres role=target_form} 'hammer'. The derivation of that oblique form is
