# Model entry implementation report — 2315 lick (iptv.2sg) / licca

## Files inspected

- `Germanic/docs/lexeme_reports/packets/2315-lick-(iptv.2sg)-licca.md`
- `Germanic/docs/lexeme_reports/dev_notes_slices/2315-lick-iptv-2sg-licca.md`
- `Germanic/docs/lexeme_reports/research_memos/2315-lick-(iptv.2sg)-licca.md`
...
- Kept the distinction explicit among row-level `PROTO *likkōną`, lexeme-level `*líkkōjaną`, and selected cell input `*líkkô`.
- Treated `licca` as a selected imperative paradigm form beside lemma `liccian`, not as a separate headword.
- Verified the paradigm comparison with a manual `oe_paradigm_probe.py` run: `*líkkōjaną -> liccian`, `*líkkô -> licca`, `*líkkōθi -> liccaþ`.
...
- No stronger local dossier for imperative `licca` turned up beyond the lemma evidence and finite-cell comparison.
