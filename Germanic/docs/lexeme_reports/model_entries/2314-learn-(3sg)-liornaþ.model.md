...
The selected form develops as **`*líznōθi > *lírnōθi`** by rhotacism, then **[lírnōθ]{.recon} ‘learn (3sg)’** after early apocope of final **`-i[*, then **]{.recon} ‘learn (3sg)’*líornōθ[* by breaking before **]{.recon} ‘learn (3sg)’rn[*, and finally **]{.recon} ‘learn (3sg)’*líornaθ > liornaþ`** by late shortening of the unstressed long vowel.

Campbell's Northumbrian **`io[* evidence and Ringe and Taylor's statement that no form of **]{.recon} ‘learn (3sg)’liornian[* stood in an i-umlauting environment support the stem, while Campbell's class-II ending evidence supports the final **]{.recon} ‘learn (3sg)’-aþ`** [@Campbell1959, §123 n. 2; @Campbell1959, §356.4; @RingeTaylor2014, 247].
