...
| :--- | :--- |
| lexical item | beech |
| citation reconstruction / lexeme label | *bōk(j)ō- |
| selected input form | *bōkō |
| Old English target | bōc |
| classification | regular |
| documented output | *bōkō -> bōc |
...
With nominative input [bōkō]{.recon} ‘beech’, the development is compact. Northwest Germanic final long `ō` 'beech' raises to `u`, and later high-vowel apocope leaves `bōc` 'beech'. The regular comparison is therefore `*bōkō > bōc`.
