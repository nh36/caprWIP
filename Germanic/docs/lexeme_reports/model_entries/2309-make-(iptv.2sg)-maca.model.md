...
paradigm form beside the headword [`macian`]{.iv lang=oe sort=macian role=comparison_form} and the related finite form [`macaþ`]{.iv lang=oe sort=macath role=comparison_form} 'make'.
