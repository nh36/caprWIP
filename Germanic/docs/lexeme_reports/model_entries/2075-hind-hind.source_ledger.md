# Source extraction ledger — hind / hind
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2075 | live row | `PROTO *xéndjō`; target `hind`; note on wrong `hindan` lexeme | regular noun | `hind`; `hindan` | Records the live target and the lexical disambiguation note. | no | `Germanic/data/germanic-aligned-final.tsv` | high |
| Compact derivation trace | current trace | `*xéndjō -> hind` | regular i-mutation and final `j` loss | `hind` | Confirms that the selected input yields the noun directly. | no | `Germanic/docs/lexeme_reports/packets/2075-hind-hind.md:17-43` | high |
