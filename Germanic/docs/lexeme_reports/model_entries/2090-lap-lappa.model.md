...
| documented output | *láppô -> lappa |

### Reconstruction and comparative evidence

The comparative sources point to a weak noun with `pp`: Orel gives `*lappōn`,
Kroonen places the word in a weak `*lappan-` family, and Kluge-Seebold cites
West Germanic `lappa` forms alongside Old English `læppa`
...
`læppa` [@ClarkHall1960, 180; @BosworthToller1898, 613].
