...
Clark Hall lemmatizes the verb as [`macian`]{.iv lang=oe sort=macian role=comparison_form}
...
[@Campbell1959, §356.4; @Campbell1959, §757]. `Macaþ` is thus the regular
comparison form for the non-`j` 3sg cell.

### Development to Old English

After early loss of final `-i`, `*mákōθi` yields [mákōθ]{.recon} 'makes'.
Anglo-Frisian brightening gives [mækōθ]{.recon} 'makes', but Campbell lists
`macian` among class-II verbs with restored `a`, so the stem returns to `mak-`
before the ending is reduced [@Campbell1959, §159].

The ending then follows ordinary class-II 3sg development: `*makōθ > *makaθ >
macaþ`. Campbell's `lufas, -aþ (< -ōsi, -ōþi)` and Ringe and Taylor's
discussion of stable class-II `a` in finite non-`j` cells support this sequence
