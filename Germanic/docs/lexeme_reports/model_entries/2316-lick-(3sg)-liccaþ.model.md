...
| Item | Value |
| :--- | :--- |
| lexical item | lick (3sg) |
| finite-stem label | *likkōną |
| lexeme-level citation form | *líkkōjaną |
| selected input form | *líkkōθi |
| Old English target | liccaþ |
| classification | late_analogy |
| documented output | *líkkōθi -> liccaþ |
