...
Orel cites a neuter lexeme of the `*xliđ-` type with Old English `hlid` 'lid', and Lloyd includes OE `hlid` beside ON `hliþó` 'lid' and OHG `(h)lit` among forms that retain `i` [@Orel2003; @Lloyd1966].

### Old English evidence

Clark Hall and Bosworth-Toller record `hlid` 'lid' as the noun 'lid, cover, door, gate' [@ClarkHall1960; @BosworthToller1898, 563].
