...
| :--- | :--- |
| lexical item | birth |
| citation reconstruction / lexeme label | *burdi- |
| selected input form | *búrdiz |
| Old English target | byrd |
| classification | regular |
| documented output | *búrdiz -> byrd |
