...
comparison form is therefore the thematic Old English noun **`brēost`**.

### Development to Old English

From `*bréustą`, the regular Old English development gives `brēost`, with the
expected `eu > ēo` vowel history [@Campbell1959]. No special repair is needed
