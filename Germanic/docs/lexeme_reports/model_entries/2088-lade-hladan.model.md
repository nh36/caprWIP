...
| :--- | :--- |
| lexical item | lade |
| citation reconstruction / lexeme label | *laθōjaną |
| selected input form | *xláðaną |
| Old English target | hladan |
| classification | early_analogy |
| documented output | *xláðaną -> hladan |

### Reconstruction and comparative evidence

Ringe and Taylor cite the strong verb `hladan` 'lade' directly [@RingeTaylor2014, 248].
...
strong Verner-grade form that reaches Old English `hladan` 'lade' directly.

### Old English evidence

Bosworth-Toller records the verb as `hladan` 'lade' and preserves the expected
...
For this entry the relevant comparison form is the infinitive `hladan` 'lade' itself.
...
`hladan` 'lade' as showing restored `a` in the present system [@Campbell1959, §744].
