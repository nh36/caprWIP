# Reviewer checklist result — 1990 dill / dile
...
| Item | Result | Note |
| :--- | :--- | :--- |
| Book-style entry about the word | yes | The prose centers on the herb name and its stem class. |
...
| Length fits the case | yes | The entry stays compact for a formation-choice entry. |

## Evidence and forms

| Item | Result | Note |
| :--- | :--- | :--- |
| Gives actual source forms | yes | `*déljaz`, `*déliz`, `dile`, and `dili` are named directly. |
| Avoids vague disagreement claims | yes | The i-stem / ja-stem split is stated explicitly. |
| Distinguishes attested / normalized / reconstructed / selected forms | yes | The attested OE noun is separated from the reconstructed PGmc formations. |
...
| Item | Result | Note |
| :--- | :--- | :--- |
| Citation keys present in `docs/refs.bib` | yes | `BosworthToller1898`, `ClarkHall1960`, `Fulk2018`, `Kroonen2013`. |
...
| Avoids overstating certainty | yes | The entry limits the claim to the OE i-stem outcome. |
