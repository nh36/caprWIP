...
| :--- | :--- |
| lexical item | timber |
| citation reconstruction / lexeme label | *tímrą |
| selected input form | *tímbrą |
| Old English target | timber |
| classification | early_analogy |
| documented output | *tímbrą -> timber |
...
[[timbr]{.recon} 'timber']{.iv lang=pwgmc sort=timbr role=comparison_form} to Old English [`timber`]{.iv lang=oe sort=timber role=target_form} 'timber' [@RingeTaylor2014, 327].
...
Clark Hall lemmatizes the noun as **[`timber`]{.iv lang=oe sort=timber role=target_form} 'timber'** and also records **[`timbor`]{.iv lang=oe sort=timbor role=comparison_form} 'timber'** as
...
| Ringe-Taylor citation line | [`*timra`]{.iv lang=pgmc sort=timra role=source_protoform} > [[timbr]{.recon} 'timber']{.iv lang=pwgmc sort=timbr role=comparison_form} | reaches the same OE noun through early cluster expansion | compatible comparative background |
