...
[timbr]{.iv .recon lang=pwgmc sort=timbr role=comparison_form} 'timber' to Old English [`timber`]{.iv lang=oe sort=timber role=target_form} 'timber' [@RingeTaylor2014, 327].
...
| Ringe-Taylor citation line | [`*timra`]{.iv lang=pgmc sort=timra role=source_protoform} > [timbr]{.iv .recon lang=pwgmc sort=timbr role=comparison_form} 'timber' | reaches the same OE noun through early cluster expansion | compatible comparative background |
