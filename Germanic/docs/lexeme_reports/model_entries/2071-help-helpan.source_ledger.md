# Source extraction ledger — help / helpan
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2071 | live row | `PROTO *xélpaną`; target `helpan`; note separating noun `help` | strong verb infinitive | `helpan`; `help` | Records the live verbal target and the noun/verb split. | no | `Germanic/data/germanic-aligned-final.tsv` | high |
| Compact derivation trace | current trace | `*xélpaną -> helpan` | regular infinitive development | `helpan` | Confirms that the selected input yields the verbal target directly. | no | `Germanic/docs/lexeme_reports/packets/2071-help-helpan.md:17-43` | high |
