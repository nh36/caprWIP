...
[`*stábaz`]{.iv lang=pgmc sort=stabaz role=selected_input} [@Orel2003, 368]. That disagreement matters because a direct i-stem input in
...
| mixed comparative notation | Orel `*stabiz ~ *stabaz`; Kluge `*stabi-/a-` | source-level stem-class uncertainty | stæf | useful comparative background, but not a single OE-facing input |
