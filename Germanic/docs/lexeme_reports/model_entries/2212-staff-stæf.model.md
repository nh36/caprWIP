...
pair singular [`stæf`]{.iv lang=oe sort=staef role=target_form} 'staff' with plural [`stafas`]{.iv lang=oe sort=stafas role=comparison_form} 'staffs' [@RingeTaylor2014, 193]. The
