...
[`spann`]{.iv lang=oe sort=spann role=comparison_form} 'span' than the exact form [`spanne`]{.iv lang=oe sort=spanne role=target_form} 'span'. Clark Hall gives [`spann`]{.iv lang=oe sort=spann role=comparison_form}
