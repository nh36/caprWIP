...
while comparable medial clusters remain unbroken; his examples include `hrefn` 'thistle',
`tacn` 'thistle', `wépn` 'thistle', and `botm` 'thistle' beside forms with parasitic vowels elsewhere in the
