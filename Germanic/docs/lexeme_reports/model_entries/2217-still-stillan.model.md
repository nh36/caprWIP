...
Clark Hall gives `stillan` as the verb and separately `stille` as the adjective [@ClarkHall1960]. Bosworth-Toller likewise preserves a substantial prefixed verbal family under `ge-stillan` and related forms [@BosworthToller1898]. The selected target is the verb `stillan`, not the adjective.
