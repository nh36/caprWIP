...
| :--- | :--- |
| lexical item | find |
| citation reconstruction / lexeme label | *fínθaną |
| selected input form | *fúnðanǭ |
| Old English target | fundene |
| classification | late_analogy |
| documented output | *fúnðanǭ -> fundene |
...
The familiar dictionary form [`funden`]{.iv lang=oe sort=funden role=comparison_form} 'find' is not
...
dictionary headword as primary. It therefore reaches [`fundene`]{.iv lang=oe sort=fundene role=target_form} 'find' in the form
where the trace and the attested evidence match directly.

### Old English evidence

Bosworth-Toller records **[`fundene`]{.iv lang=oe sort=fundene role=target_form} 'find'** under [`findan`]{.iv lang=oe sort=findan role=comparison_form} 'find', citing the form in
_Beón þá herigeata swa fundene_ [@BosworthToller1898, 219]. Clark Hall likewise preserves the
participial stem in forms such as [`funden`]{.iv lang=oe sort=funden role=comparison_form} 'find' and `tō-fundennes` 'find'
[@ClarkHall1960, 124].

The ordinary dictionary headword for the participle is [`funden`]{.iv lang=oe sort=funden role=comparison_form} 'find', but the
relevant comparison form for this entry is the attested oblique **[`fundene`]{.iv lang=oe sort=fundene role=target_form} 'find'**.
...
weakening of the final ending, yielding [`fundene`]{.iv lang=oe sort=fundene role=target_form} 'find'. In that cell both the
...
familiar nominative [`funden`]{.iv lang=oe sort=funden role=comparison_form} 'find' is the ordinary dictionary form, whereas the
oblique form [`fundene`]{.iv lang=oe sort=fundene role=target_form} 'find' is the attested form compared here.
