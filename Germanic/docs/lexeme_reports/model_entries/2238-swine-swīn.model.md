...
| :--- | :--- |
| lexical item | swine |
| citation reconstruction / lexeme label | `*swī́ną` |
| selected input form | `*swḯną` |
| Old English target | `swīn` |
| classification | regular |
| documented output | `*swḯną -> swīn` |
...
From selected input [swḯną]{.recon} ‘swine’, loss of the final nasal vowel yields [`swīn`]{.iv lang=oe sort=swin role=comparison_form} 'swine, pig'. The outcome is therefore the regular monosyllabic noun with preserved long root `ī`.
