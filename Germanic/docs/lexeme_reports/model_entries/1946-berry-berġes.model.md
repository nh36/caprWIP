...
Ringe and Taylor's [`here`]{.iv lang=oe sort=here role=comparison_form} 'army', [`herges`]{.iv lang=oe sort=herges role=comparison_form} 'army's' comparison shows the same `rj` environment in
