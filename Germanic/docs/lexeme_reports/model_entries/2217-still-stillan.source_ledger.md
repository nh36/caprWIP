# Source extraction ledger — still / stillan
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2217 | live row | `PROTO *stéllijaną`; target `stillan` | heavy-stem Class I weak verb | `stillan` | The live row already treats the lexeme as a regular verb row. | no | `Germanic/data/germanic-aligned-final.tsv`; `production_backlog.tsv` | high |
| Compact derivation trace | current trace | `*stéllijaną -> stillan` | regular verbal derivation | `stillan` | Confirms the exact current output. | no | `Germanic/docs/lexeme_reports/packets/2217-still-stillan.md` | high |
