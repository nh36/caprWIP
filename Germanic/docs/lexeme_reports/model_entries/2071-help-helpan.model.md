...
The entry treats the strong verb itself rather than the separate noun [help]{.lex lang=oe} 'help'. Bright's principal parts `helpan, healp, hulpon, holpen` show the ordinary Old English strong-verb family continued by this input [@BrightCassidyRingler1971].
