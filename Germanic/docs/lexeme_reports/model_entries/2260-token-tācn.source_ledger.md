# Source extraction ledger — token / tācn
        ...
        | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
        | TSV row 2260 | live row | `PROTO *táikną`; target `tācn` | neuter noun | `tācn` | Establishes the selected input and OE target. | no | `Germanic/data/germanic-aligned-final.tsv`; packet | high |
| Compact derivation trace | current trace | `*táikną -> tācn` | regular noun derivation | `tācn` | Confirms the exact current output. | no | packet; debug snapshot | high |
