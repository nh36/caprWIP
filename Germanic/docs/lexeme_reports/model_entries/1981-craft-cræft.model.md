...
`*kraftu-`, while Orel prints [kraftiz ~ *kraftuz]{.recon} ‘craft’ [@Kroonen2013, 340; @Orel2003,
259].
...
comparator [kráftiz]{.recon} ‘craft’ gives `creft` 'craft', while the u-stem comparator [kráftuz]{.recon} ‘craft’
gives `craft` 'craft'. The a-stem-shaped input [kráftaz]{.recon} ‘craft’ yields `cræft` 'craft' and is
