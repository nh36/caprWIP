# Source extraction ledger — sleep / slǣpan
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2196 | live row | `PROTO *slḗpaną`; target `slǣpan` | strong verb, class VII | `slǣpan` | The live row already treats the lexeme as a regular infinitive row. | no | `Germanic/data/germanic-aligned-final.tsv`; `production_backlog.tsv` | high |
| Compact derivation trace | current trace | `*slḗpaną -> slǣpan` | regular verbal derivation | `slǣpan` | Confirms the exact current output. | no | `Germanic/docs/lexeme_reports/packets/2196-sleep-slǣpan.md` | high |
