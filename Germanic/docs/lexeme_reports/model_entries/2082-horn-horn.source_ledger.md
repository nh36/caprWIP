# Source extraction ledger — horn / horn
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2082 | live row | `PROTO *xúrną`; target `horn`; note on oblique `*xurnăn` | regular noun with comparative note | `horn` | Records the live input, target, and oblique-form background. | no | `Germanic/data/germanic-aligned-final.tsv` | high |
| Compact derivation trace | current trace | `*xúrną -> horn` | u-lowering and final nasal loss | `horn` | Confirms that the selected input yields the target directly. | no | `Germanic/docs/lexeme_reports/packets/2082-horn-horn.md:17-43` | high |
