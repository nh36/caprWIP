...
The wider history of competing [`mēd`]{.iv lang=oe sort=med role=comparison_form} 'meed, reward' remains disputed. Kroonen and Fulk
...
competing [`mēd`]{.iv lang=oe sort=med role=comparison_form} 'meed, reward' tradition.
