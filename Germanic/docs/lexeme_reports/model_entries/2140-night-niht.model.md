...
fluctuation between [`neaht`]{.iv lang=oe sort=neaht role=comparison_form} 'night' and [`niht`]{.iv lang=oe sort=niht role=target_form} 'night', giving genitive `nihte, nihtes`,
