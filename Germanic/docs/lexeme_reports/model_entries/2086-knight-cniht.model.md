...
Ringe and Taylor cite `*kneht`, Orel gives `*knextaz`, and Kluge-Seebold
likewise points to `*knehta-` [@RingeTaylor2014; @Orel2003, 256;
...
From `*knéxtaz`, the relevant Old English changes include breaking before the
velar cluster and then the later reduction that yields `cniht`
