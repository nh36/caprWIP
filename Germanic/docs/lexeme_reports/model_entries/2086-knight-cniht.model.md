...
| documented output | *knéxtaz -> cniht |
...
@BosworthToller1898, 71]. Campbell cites plural [`cneohtas`]{.iv lang=oe sort=cneohtas role=comparison_form} 'knight' among the broken
...
notes the early West-Saxon alternation [`cniht`]{.iv lang=oe sort=cniht role=target_form} beside plural [`cneohtas`]{.iv lang=oe sort=cneohtas role=comparison_form} 'knight'
