...
of OE `-ig`, including forms such as `hunig` 'withy', supports an analysis in which the
...
Clark Hall records the noun as [`wiðig`]{.iv lang=oe sort=withig role=comparison_form} 'withy' [@ClarkHall1960, 358]. The form used here,
[`wīþiġ`]{.iv lang=oe sort=withig role=target_form} 'withy', is a normalized Old English spelling with macrons and palatal ġ marked
explicitly.
...
Palatalization supplies the final `ġ` 'withy', and the full development reaches
