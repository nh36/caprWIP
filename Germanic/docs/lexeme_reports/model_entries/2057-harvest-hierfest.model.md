...
| Item | Value |
| :--- | :--- |
| lexical item | harvest |
| citation reconstruction / lexeme label | *harbistuz |
| selected input form | *xárbistuz |
| Old English target | hierfest |
| classification | regular |
| documented output | *xárbistuz -> hierfest |

### Reconstruction and comparative evidence

Bammesberger and Ringe-Taylor treat `*harbist-` as the inherited base and explain that the regular native West Saxon development would be of the `hierfest / hyrfest` type [@Bammesberger1997; @RingeTaylor2014].
