# Source extraction ledger — sunder / sundrian
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2232 | live row | `PROTO *súndrōjaną`; target `sundrian` | Class II weak verb | `sundrian` | The live row already treats the lexeme as the class-II verb row. | no | `Germanic/data/germanic-aligned-final.tsv`; `production_backlog.tsv` | high |
| Compact derivation trace | current trace | `*súndrōjaną -> sundrian` | regular verbal derivation | `sundrian` | Confirms the exact current output. | no | `Germanic/docs/lexeme_reports/packets/2232-sunder-sundrian.md` | high |
