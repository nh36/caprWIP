# Source extraction ledger — tide / tīd
        ...
        | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
        | TSV row 2257 | live row | `PROTO *tī́diz`; `PROTOFORM *tḯdiz`; target `tīd` | feminine i-stem noun | `tīd` | Establishes the selected input and OE target. | no | `Germanic/data/germanic-aligned-final.tsv`; packet | high |
| Compact derivation trace | current trace | `*tḯdiz -> tīd` | regular i-stem derivation | `tīd` | Confirms the exact current output. | no | packet; debug snapshot | high |
