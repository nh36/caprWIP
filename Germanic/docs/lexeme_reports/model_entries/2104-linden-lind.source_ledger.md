# Source extraction ledger — linden / lind
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2104 | live row | `PROTO *líndō`; target `lind` | feminine noun | `lind` | The row already treats this as a regular noun and notes that `linden` is not the OE form. | no | `Germanic/data/germanic-aligned-final.tsv`; `production_backlog.tsv` | high |
| Compact derivation trace | current trace | `*líndō -> lind` | final-`ō` noun | `lind` | Confirms the regular apocope pathway. | no | `Germanic/docs/lexeme_reports/packets/2104-linden-lind.md` | high |
