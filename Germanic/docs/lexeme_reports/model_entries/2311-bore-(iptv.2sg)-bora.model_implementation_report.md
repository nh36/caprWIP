# Model entry implementation report — 2311 bore (iptv.2sg) / bora

## Files inspected

- `Germanic/docs/lexeme_reports/packets/2311-bore-(iptv.2sg)-bora.md`
- `Germanic/docs/lexeme_reports/dev_notes_slices/2311-bore-(iptv.2sg)-bora.md`
- `Germanic/docs/lexeme_reports/research_memos/2311-bore-(iptv.2sg)-bora.md`
...
- The ordinary dictionary headword remains `borian`, so `bora` must stay clearly marked as a normalized imperative form.
- No direct lexicographic attestation of verbal `bora` was found in the local dictionary material used here.

## OCR and source-transcription checks

- No suspicious OCR form needed correction in the final prose.
- The Kroonen and Clark Hall passages used here were legible in the local vision files, and the Ringe-Taylor passage was clear in the local text file.
