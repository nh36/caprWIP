# Source extraction ledger — wax / weaxan
        ...
        | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
        | TSV row 2276 | live row | `PROTO *wáxsaną`; target `weaxan` | strong verb infinitive | `weaxan` | Establishes the selected input and OE target. | no | `Germanic/data/germanic-aligned-final.tsv`; packet | high |
| Compact derivation trace | current trace | `*wáxsaną -> weaxan` | regular verbal derivation | `weaxan` | Confirms the exact current output. | no | packet; debug snapshot | high |
