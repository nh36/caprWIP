# Source extraction ledger — hair / hǣr
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2051 | live row | `PROTO *xḗrą`; target `hǣr`; note on wrong `*xazwăz` lexeme | regular noun | `hǣr` | Records the live input and the identity-cleanup note. | no | `Germanic/data/germanic-aligned-final.tsv` | high |
| Compact derivation trace | current trace | `*xḗrą -> hǣr` | regular lowering and apocope | `hǣr` | Confirms that the selected input now yields the target directly. | no | `Germanic/docs/lexeme_reports/packets/2051-hair-hǣr.md:17-43` | high |
