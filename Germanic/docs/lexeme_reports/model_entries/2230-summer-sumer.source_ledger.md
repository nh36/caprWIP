# Source extraction ledger — summer / sumer
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSV row 2230 | live row | `PROTO *súmaraz`; target `sumer` | noun | `sumer` | The live row treats `sumer` as the regular OE target. | no | `Germanic/data/germanic-aligned-final.tsv`; `production_backlog.tsv` | high |
| Compact derivation trace | current trace | `*súmaraz -> sumer` | regular nominal derivation | `sumer` | Confirms the exact current output. | no | `Germanic/docs/lexeme_reports/packets/2230-summer-sumer.md` | high |
