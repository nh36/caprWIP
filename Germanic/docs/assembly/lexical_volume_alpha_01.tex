...
and Taylor 2014}). The Old English form here here is therefore the
attested neuter \emph{dor}, while \emph{duru} remains a parallel Old
English reflex from another stem history.
...
West Saxon \emph{ġiest} is the Old English form here here. Anglian
...
\emph{heġġ} is the Old English form here here, while the ordinary
...
West Saxon \emph{healdan} is the Old English form here here. Anglian and
...
selected genitive singular & *brándas & regular output: \emph{brandes} &
brandes & exact match for the chosen oblique cell \\
\end{longtable}
}
...
& lungen & exact match between form compared hereation and attested OE
noun \\
...
The comparison below sets the relevant forms side by side. It separates
the competing comparative stem lines from the selected OE-facing input.
...
selected genitive singular & *swánas & regular output: \emph{swanes} &
...
here \\
modeled input & \emph{*xwálaz} & regular output: \emph{hwæl} & selected
OE-facing input \\
...
This derivation is regular for the form compared hereation. The central
claim of the entry is therefore morphological: Old English \emph{wīþiġ}
...
selected \emph{*-ag-} derivative & *wī́θagą & regular output:
...
The Old English form here here is the West Saxon form \emph{weorold}. It
...
From the derivational input \emph{*wír-àldu}, Northwest Germanic
...
selected OE-facing input & \emph{*wír-àldu} & regular output:
...
that remain outside the Old English form here line \\
\end{longtable}
}
...
316}). The selected comparative label \emph{*júgunθiz} already stands at
a later Germanic stage with \emph{g}, and the chosen input
...
selected OE-facing input & \emph{*júgunθ} & regular output:
...
selected genitive singular & *bánnas & regular output: \emph{bannes} &
bannes & direct match for the conservative genitive \\
\end{longtable}
}
...
contrast between the citation form and the selected genitive singular
cell.
...
English form here \\
selected genitive singular & *bázjas & regular output: \emph{berġes} &
berġes & exact match for the chosen conservative cell \\
\end{longtable}
}
...
selected genitive singular & *xámaras & regular output: \emph{hameres} &
hameres & exact match between input, output, and attested cell \\
...
leveling \\
selected 3sg present & *xábēθi & regular output: \emph{hæfeþ} & hæfeþ &
exact match between input, output, and selected finite cell \\
...
selected 3sg present & *líbēθi & regular output: \emph{lifeþ}; attested
...
The comparison below sets the relevant forms side by side. It separates
the citation-form line from the selected genitive singular.
...
selected genitive singular & *mánnas & regular output: \emph{mannes} &
mannes & exact match between input, output, and attested comparator \\
\end{longtable}
}
...
selected imperative singular & \emph{*mákô} & regular output:
...
here \\
selected 3sg present & \emph{*mákōθi} & regular output \emph{macaþ} &
macaþ & exact match \\
...
here \\
selected imperative singular & \emph{*búrô} & regular output \emph{bora}
& bora & exact match \\
...
\emph{borian} & borian & family background, but not the cell compared
here \\
selected 3sg present & \emph{*búrōθi} & regular output \emph{boraþ} &
boraþ & exact match \\
...
selected imperative singular & \emph{*líznô} & regular output and
...
\emph{liornian}; dictionary headword often \emph{leornian} & liornian /
leornian & family background, but not the cell compared here \\
selected 3sg present & \emph{*líznōθi} & regular output \emph{liornaþ} &
liornaþ & exact match \\
...
\emph{licca} & licca & exact match between the chosen input and the Old
English form here \\
...
chosen input and the Old English form here \\
...
& exact match for the cell compared here \\
\end{longtable}
}
