...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 145}). The attested forms do
not decide the question: Old English \emph{flēah} `flea' and Old Norse
\emph{fló} `flea' are compatible with both reconstructions. This is a
case where reputable sources disagree about the morphological class
itself, and the disagreement is documented here rather than silently
normalized away.
