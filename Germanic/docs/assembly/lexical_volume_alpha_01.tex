...
114}; \citeproc{ref-Orel2003}{Orel 2003, 95};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 43}).

The form followed here, \emph{*bréustą}, therefore differs from the
citation label \emph{*brústz} because Old English reflects the thematic
branch rather than the root noun. The morphological choice comes before
the Old English sound changes themselves.
...
\emph{brēost} \\
selected thematic formation & *bréustą & regular output: \emph{brēost} &
brēost & exact match between formation and attested OE noun \\
\end{longtable}
}
...
35}; \citeproc{ref-Seebold1970}{Seebold 1970, 89}). The citation
...
and the unstressed vowel develops regularly to give \emph{bannes}. The
paradigm comparison therefore sets the genitive against nominative
\emph{ban}, the ordinary nominative form of the same noun, rather than
against a directly cited genitive headword.
...
\bottomrule\noalign{}
\endlastfoot
citation nominative singular & *bánną & regular output: \emph{ban} & ban
& regular nominative outcome, but not the Old English form here \\
genitive singular & *bánnas & regular output: \emph{bannes} & bannes &
direct match for the conservative genitive \\
\end{longtable}
}
...
derivational input \emph{*bázjas} is therefore not a rival lexeme
headword, but a specific genitive singular cell drawn from that
paradigm.
...
genitive \emph{berġes}, which is best read here as the regular genitive
comparison form rather than as a dictionary headword.

\paragraph{Development to Old
English}\label{development-to-old-english-110}

Citation \emph{*bázją} gives \emph{bere}, not the Old English form here.
The genitive singular \emph{*bázjas}, however, gives \emph{berġes}, with
...
\bottomrule\noalign{}
\endlastfoot
citation nominative singular & *bázją & regular output: \emph{bere} &
berige / berġe & useful citation-form background, but not the Old
English form here \\
genitive singular & *bázjas & regular output: \emph{berġes} & berġes &
exact match for the conservative cell \\
\end{longtable}
}
