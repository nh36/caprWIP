...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 717}). The form followed here,
...
\emph{būgan} & būgan & establishes the lexeme, but not the Old English
form here \\
singular preterite & *báug & regular output: \emph{bēag} & bēag & exact
match between input, output, and attested cell \\
