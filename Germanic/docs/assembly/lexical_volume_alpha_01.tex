...
genitive singular & *brándas & regular output: \emph{brandes} & brandes
& exact match for the oblique cell \\
\end{longtable}
}
...
Ringe and Taylor, however, reconstruct \emph{*sparai-} \textasciitilde{}
\emph{*sparja-} for the English branch and derive the citation verb from
a class-II line (\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014,
162, 191}). The form followed here, \emph{*spárōjaną}, therefore
represents the refashioned class-II formation behind Old English
\emph{sparian}, while the citation reconstruction \emph{*sparēną}
...
\bottomrule\noalign{}
\endlastfoot
inherited class-III infinitive & *spárēną & paradigm comparison / probe
output: \emph{sparen} & sparian & wrong class and wrong ending for the
citation verb \\
inherited class-III imperative singular & *spárē & paradigm comparison /
probe output: \emph{spære} & Ritual \emph{spær} & loss of final
\emph{-e} is not regular, so the relic form cannot control the entry \\
inherited class-III finite present & *spárēθi & paradigm comparison /
probe output: \emph{spæreþ} & \emph{spearad} & attested form is mixed,
not a direct continuation of the inherited cell \\
selected class-II formation & *spárōjaną & documented regular output:
\emph{sparian} & sparian & exact match between derivational input and
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 220}). The form followed here,
...
From \emph{*xémonų}, the West Saxon line passes through the oblique-stem
type reflected in northern WGmc \emph{*hebun}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 324}). Campbell's
\emph{heofon} beside \emph{hefen} and earlier \emph{hefzen} show the
later West-Saxon back-mutation and suffix reshaping behind \emph{heofon}
...
type outcome & hefen / heofen & useful control, but not the West Saxon
form used here \\
selected oblique singular & *xémonų & regular output: \emph{heofon} &
heofon & exact match between input, output, and target \\
...
entry \\
present third singular & \emph{*líkkōθi} & regular output \emph{liccaþ}
& liccaþ & exact match between the derivational input and the Old
English form here \\
\end{longtable}
}
...
scēawa / normalized sċēawa & exact match between the derivational input
and the Old English form here \\
