...
\emph{tēon} is therefore a \textbf{normalized spelling} of that
un-umlauted base.
...
\emph{h/x} yields \emph{*téoon}, and contraction produces \emph{*tḗon},
written \emph{tēon}. This is the regular bare-cardinal path.

The umlauted forms \emph{tien / tīen} belong to a different branch,
created when the numeral was levelled from inflected forms with a
front-vocalic trigger (\citeproc{ref-Fulk2018}{Fulk 2018, sect. 10.2};
...
\emph{stebn \textgreater{} stefn \textgreater{} stemn}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 330}). Orel
likewise gives \emph{*stebnō \textasciitilde{} *stemnō}, whereas Kroonen
prefers \emph{*stimnō-}, and Fulk describes the etymology of
...
\textbf{genitive singular} of the same paradigm.
...
The target is therefore an \textbf{attested Old English genitive
singular}, not a reconstruction. It is also not the ordinary citation
lemma. The entry must keep those two facts distinct.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013}). Ringe and Taylor instead
state the history from \emph{PGmc *timra} through West Germanic
...
\emph{timber}. Ringe and Taylor's \emph{*timra \textgreater{} *timbr
\textgreater{} OE timber} and the handbook treatment of this epenthetic
vowel point to the same Old English result
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014};
...
\emph{*wakai- \textasciitilde{} *wakja-}
...
\emph{*watar-\textasciitilde*watan-} and states that the Proto-Germanic
material points to \emph{*watōr, *watenaz}
...
\emph{*wætær}, and merger of unstressed \emph{æ/e} yields \emph{wæter}.
...
2003}). Kroonen instead cites \emph{*hwali-}
(\citeproc{ref-Kroonen2013}{Kroonen 2013}).
...
Campbell's \emph{lufas, -aþ (\textless{} -ōsi, -ōþi)} and Ringe and
Taylor's discussion of stable \emph{a} in the finite non-\emph{j} cells
point to \emph{*makōθ \textgreater{} *makaθ \textgreater{} macaþ}
...
Ringe and Taylor's class-II imperative singular \emph{-a \textless{}
*-ō} points to exactly this type of outcome
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). The selected
...
Campbell's class-II pattern \emph{lufas, -aþ (\textless{} -ōsi, -ōþi)}
and Ringe and Taylor's account of stable \emph{a} in the class-II 2sg
and 3sg make this finite cell the relevant comparison form for the
ending (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 355.4};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
sequence (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 355.4};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
leornian} from a learn-family base of the \emph{*lizn-} type, and
...
*lírnô} by rhotacism, then \emph{*líornô} by breaking before \emph{rn},
and finally \emph{*líorna} by late shortening of the unstressed long
vowel.
...
For the ending, Campbell's \emph{lufas, -aþ (\textless{} -ōsi, -ōþi)}
and Ringe and Taylor's discussion of stable \emph{a} in the class-II 2sg
and 3sg make the non-\emph{j} 3sg cell the relevant comparison point
(\citeproc{ref-Campbell1959}{Campbell 1959, sect. 355.4};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
The selected form develops as \emph{*líznōθi \textgreater{} *lírnōθi} by
rhotacism, then \emph{*lírnōθ} after early apocope of final \emph{-i},
then \emph{*líornōθ} by breaking before \emph{rn}, and finally
\emph{*líornaθ \textgreater{} liornaþ} by late shortening of the
...
diphthongal sequence, and from West Saxon \emph{strewian / streowian /
strēawian}, where the verb has already been remodelled into class II
(\citeproc{ref-Fulk2018}{Fulk 2018, sect. 4.10} n.~1;
