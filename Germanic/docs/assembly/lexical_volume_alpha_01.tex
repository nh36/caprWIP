...
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-SieversBrunner1965}{Brunner 1965}). This entry treats the
...
used here, {\emph{ġealla}}, is a normalized spelling with macrons
omitted and palatal ġ made explicit.
...
Clark Hall keeps {\emph{wacan}} and {\emph{wacian}} as separate
headwords (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 338}).
Bosworth-Toller adds an important caution under {\emph{wacan}}: the
simplex infinitive itself does not occur, its place seeming to be taken
by {\emph{wæcnan}} (\citeproc{ref-BosworthToller1898}{Bosworth and
Toller 1898, 226}).
...
The derivational input {\emph{*wír-àldu}} therefore differs from the
...
citation form. That distinction is important because the Old English
evidence for the \emph{meord} side is oblique.
...
continued by Anglian {\emph{strēgan}}, while West Saxon
