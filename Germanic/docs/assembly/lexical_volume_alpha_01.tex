...
\emph{*swḯną} \textgreater{} \emph{swīn} (regular).
...
\emph{*tḯdiz} \textgreater{} \emph{tīd} (regular).
...
\emph{*xwḯnaną} \textgreater{} \emph{hwīnan} (early analogy).
...
\emph{*wḯθagą} \textgreater{} \emph{wīþiġ} (early analogy).
