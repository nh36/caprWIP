...
(\citeproc{ref-Kroonen2013}{Kroonen 2013}). Ringe and Taylor give the
plural development directly as PNWGmce \emph{*brokiz} \textgreater{}
...
selected input here is the plural noun form \emph{*brōkiz}.
...
The selected input \emph{*fléuganą} represents that inherited strong
...
separate haddr / heordan / \emph{hād-} material does not displace the
...
describe West Saxon meolc \textless{} meoluc \textless{} \emph{*meluk},
...
2013}; \citeproc{ref-Orel2003}{Orel 2003}). The selected input
...
preterite wax/\emph{wēox} belong to different lexical or paradigm slots.
...
\emph{*weljōn}/\emph{*weljOn} (\citeproc{ref-Kroonen2013}{Kroonen 2013};
\citeproc{ref-Orel2003}{Orel 2003};
...
The umlauted forms tien / \emph{tīen} belong to a different branch,
...
selected target \\
tien / \emph{tīen} & attested West Saxon umlauted simplex forms &
...
earlier waefs / \emph{wæfs} through restricted metatheses
...
\emph{brēost}, with the expected eu \textgreater{} \emph{ēo} vowel
...
\textasciitilde{} folgian and describe it as a dual formation that
probably reflects an older alternation between j-present and e-stative
...
/ fylgean}, here normalized as \emph{fylġan}. The spelling with \_
...
\emph{*nabulō} \textgreater{} \emph{*næbula} \textgreater{} nafola
(\citeproc{ref-Kroonen2013}{Kroonen 2013};
...
Ringe also cites the pair \emph{*nēþlō-} \textasciitilde{}
\emph{*nēdlō-} (\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014};
...
is more specific for Old English, citing nosu \textless{} \emph{*nusō}
(\citeproc{ref-Campbell1959}{Campbell 1959}).
...
\emph{*nósu} \textgreater{} nosu. The early special step lies in the
choice of the zero-grade input, not in any late Old English repair.
...
Hall 1960}), and Kluge-Seebold likewise cites ae. \emph{sæp} n.
...
\emph{*sǣi} history, with loss of \emph{u/w} before \emph{i}
...
\textgreater{} \emph{*síβe} \textgreater{} sife. Medial \emph{b} is
realized as a spirant and later written \emph{f}, while the final
...
\emph{swan, m., swan: gs. swanes} and citing the phrase swanes
\emph{feðre} (\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}).
...
\emph{*watar-}\textasciitilde{}\emph{*watan-} and states that the
Proto-Germanic material points to \emph{*watōr}, \emph{*watenaz}
...
Ringe and Taylor add the dialectal contrast between West Saxon
...
heteroclitic stem notation &
\emph{*watar-}\textasciitilde{}\emph{*watan-} & source-faithful
comparative reconstruction & explains why a singular comparator is
needed \\
...
spelling with macrons and palatal \_.
...
\textasciitilde{} worold} & explains the older comparative literature
cited for the word \\
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Campbell makes
the same point with the parallel \emph{duguþ} \textless{}
\emph{*dugunþ-}, adding \emph{geoguþ} to the same history
(\citeproc{ref-Campbell1959}{Campbell 1959}). The selected input
...
records forms of the \emph{iuguþ} / \emph{gioguð} / \emph{geoguð} type,
and Ringe and Taylor likewise cite \emph{geoguþ} \textasciitilde{}
...
\emph{*bazja-} (\citeproc{ref-Kroonen2013}{Kroonen 2013}). The selected
input \emph{*bázjas} is therefore not a rival lexeme headword, but a
...
singular preterite au \textgreater{} \emph{ēa} development as regular in
...
the word from the nominative citation form: they cite gen.sg.
\emph{*nahtiz}, dat.sg. \emph{*nahti}, and nom.pl. \emph{*nahtiz}, and
derive West Saxon \emph{niht} from that side of the paradigm
...
\emph{dæg} by analogy with dat. sg. niht \textless{} \emph{*nahti}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
\textgreater{} \emph{*nixti} \textgreater{} niht.
...
\emph{scufan, sceaf, scufon, scofen} and also quotes he sceaf \emph{þa}
mid \emph{þam} scylde; Sweet gives the same paradigm
(\citeproc{ref-BrightCassidyRingler1971}{Bright 1971};
...
sect. 355.4}; \citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
\emph{-ōsi}, \emph{-ōþi)}, and Ringe and Taylor likewise treat the
...
(\textless{} \emph{-ōsi}, \emph{-ōþi)}, and Ringe and Taylor likewise
treat the class-II 2sg and 3sg as forms with stable \emph{-a-}
(\citeproc{ref-Campbell1959}{Campbell 1959};
...
diphthongal sequence, and from West Saxon strewian / streowian /
\emph{strēawian}, where the verb has already been remodelled into class
II (\citeproc{ref-Fulk2018}{Fulk 2018, sect. 4.10} n.~1;
...
trace-supported & selected target \\
strewian / streowian / \emph{strēawian} & attested remodelled West Saxon
...
\emph{rúst} / rust & selected target; the citation-form development
remains unexplained \\
\end{longtable}
}
...
\emph{*wólfaz} \textgreater{} \emph{*wólfa} \textgreater{} wolf.
...
\emph{*wúlfi} / \emph{*wúlfis} -\textgreater{} wylf / wylfe & expected
