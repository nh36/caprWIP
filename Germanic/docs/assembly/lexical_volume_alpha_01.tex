...
Derivation: \emph{*stámnaz} yields regular \emph{stamn}; the Old English
form here is \emph{stefn} (known but unmodelled development).

\paragraph{Derivation trace}\label{derivation-trace-139}

Proto input: \emph{*stámnaz}
...
{\emph{heofon}} `heaven') handled by the \emph{PNWGmcMnDissimilation}
