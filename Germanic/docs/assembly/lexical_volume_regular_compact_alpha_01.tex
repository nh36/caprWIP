...
\emph{gebanne} (\citeproc{ref-BosworthToller1898}{Bosworth and Toller
1898, 303}). The exact unprefixed genitive \emph{bannes} is less
directly cited in the reviewed material, so it is best treated here as
the selected regular genitive comparison form rather than as a
dictionary headword.
...
444}). Ringe and Taylor also show that the English present system
...
singular cell of the feminine ō-stem paradigm
