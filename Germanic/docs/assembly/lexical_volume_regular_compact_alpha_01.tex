...
between earlier Germanic forms and Old English reflexes under the
current cascade. The variant, analogy, reconstructed-comparator, and
exception classes then show where that baseline does not by itself
...
Old English reflex stand in a straightforward relation under the current
cascade. These entries form the baseline against which the analogy and
exception classes are interpreted.
...
\emph{Fell} (\citeproc{ref-Kroonen2013}{Kroonen 2013, 135}). The
selected input \emph{*féllą} is the derivable singular form of that same
...
strong verb in the notation used here. Clark Hall likewise records
\emph{flēogan} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 106}).
Bright gives the familiar paradigm \emph{flēag}, flugon, flogen with
present \emph{fleogeð} (\citeproc{ref-BrightCassidyRingler1971}{Bright
1971, 363}). From \emph{*fléuganą}, Old English diphthong leveling gives
...
(\citeproc{ref-Orel2003}{Orel 2003, 164}). The selected input
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 260}). The selected input
...
2013, 259}; \citeproc{ref-Orel2003}{Orel 2003, 234}).
...
(\citeproc{ref-Orel2003}{Orel 2003, 377}). The selected input
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 482}). The selected input
...
\citeproc{ref-Fulk2018}{Fulk 2018, 120}). The selected input
...
198, 263}). The selected form is the West Saxon citation form
...
Hall 1960, 286}; \citeproc{ref-SieversBrunner1965}{Sievers 1965, sects
392, 396}). From \emph{*spánnaną}, the final nasal ending is lost and
the regular OE weak-tail steps surface \emph{spannan}.
...
\citeproc{ref-Orel2003}{Orel 2003, 362}). The selected input
...
family of adjective \emph{still} and verb \emph{stillen} in view
(\citeproc{ref-KlugeSeebold2011}{Kluge 2011, 885}). Clark Hall gives
\emph{stillan} as the verb and separately \emph{stille} as the adjective
...
Taylor 2014, 197}). The selected input here is the verbal form
...
also points to related \emph{wearp} material. The selected form here is
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 611}). The selected input
...
variant form (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 343}).
...
(\citeproc{ref-Fulk2018}{Fulk 2018, 170}). The selected input
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 165}). The selected input
...
506}). The selected input \emph{*knéxtaz} follows that comparative
evidence.
...
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 180}). The selected input
...
\citeproc{ref-Kroonen2013}{Kroonen 2013, 363}). The selected input
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 384}). The selected input
...
(\citeproc{ref-Orel2003}{Orel 2003, 218}). The selected input
...
162, 191}). The selected input \emph{*spárōjaną} therefore represents
the refashioned class-II formation behind Old English \emph{sparian},
while the citation reconstruction \emph{*sparēną} remains the inherited
comparative headword.
...
376}). The selected input \emph{*wī́θagą} is thus a formation choice
rather than a mere respelling of the comparative headword.
...
\emph{bannes} & bannes & direct match for the conservative genitive \\
\end{longtable}
}
...
2014, 344}). The selected input \emph{*fúnðanǭ}, however, belongs to the
...
participle from the more familiar nominative participial forms and keeps
the cited Old English evidence alongside the regular derivational path.
...
2003, 120}). The selected input \emph{*fúrxtīnaz} is not a different
lexeme but an oblique singular cell within that in-stem paradigm.
...
\citeproc{ref-Orel2003}{Orel 2003, 299}). The selected input
...
445}). The selected input \emph{*rástōz} therefore does not replace the
...
(\citeproc{ref-Seebold1970}{Seebold 1970, 450}). The selected input
\emph{*spánnai} is therefore not a rival headword, but a specific dative
singular cell chosen on the model of the feminine ō-stem paradigm
(\citeproc{ref-SieversBrunner1965}{Sievers 1965, sect. 252};
...
\emph{spanne} is accordingly treated as the selected regular dative
singular comparison form rather than as a dictionary headword.
...
while the selected input \emph{*θístilas} is a specific genitive
singular cell.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 85}). The selected form
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 151}). The selected input
...
(\citeproc{ref-Orel2003}{Orel 2003, 62}). The selected input therefore
