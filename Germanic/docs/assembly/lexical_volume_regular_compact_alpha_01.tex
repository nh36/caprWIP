...
the plural development directly as PNWGmc \emph{*brokiz} \textgreater{}
...
records \emph{sponnan, spannan stv.} {[}Clark Hall
(\citeproc{ref-ClarkHall1960}{1960}), 286; Sievers
(\citeproc{ref-SieversBrunner1965}{1965}), §392; §396{]}. From
...
reconstruction \emph{*bánną} therefore names the lexeme, but the
selected input \emph{*bánnas} is a specific genitive singular cell.
...
paradigm comparison therefore sets the selected genitive against
nominative comparator \emph{ban}, the citation-form comparison cell of
the same noun, rather than against a separately cited genitive headword.
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 395--96}). In
...
the selected input \emph{*skáub} is not a spelling variant of the
infinitive: it is the separate singular-preterite cell chosen here for
comparison with \emph{sċēaf}.
