...
(\citeproc{ref-Campbell1959}{Campbell 1959, 174}). Bosworth-Toller and
Clark Hall lemmatize the verb as \emph{be-ginnan} / \emph{beginnan}
(\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 84};
\citeproc{ref-ClarkHall1960}{Clark Hall 1960}). From \emph{*bigínnaną},
...
unstressed-prefix development (\citeproc{ref-RingeTaylor2014}{Ringe and
Taylor 2014}).
...
125}). From \emph{*búrdiz}, loss of final \emph{z} gives \emph{*búrdi}.
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Bright notes
\emph{brōc} with plural \emph{brēc}, and Clark Hall gives \emph{brēc}
fp. breeches while also listing \emph{broc} as a feminine noun probably
represented chiefly in the plural
...
that Primitive Germanic \emph{ē} appears as West Saxon \emph{ǣ} but in
other Old English dialects mostly as \emph{ē}, and Brunner gives the
contrast explicitly as West Saxon \emph{dǣd} beside non-West-Saxon
\emph{dēd} (\citeproc{ref-Campbell1959}{Campbell 1959};
\citeproc{ref-SieversBrunner1965}{Sievers 1965}). From inherited
\emph{*dēdiz}, loss of final \emph{-z} and the West Saxon lowering of
stressed long \emph{ē} yield \emph{dǣd}; Anglian \emph{dēd} preserves
the non-West-Saxon outcome (\citeproc{ref-Campbell1959}{Campbell 1959};
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013}). Clark Hall records
...
heavy-syllable nasal apocope then yields \emph{dor}.
...
hide', and Bright's glossary likewise gives \emph{fell} with inflected
forms such as accusative singular \emph{fel} and dative plural
\emph{fellum} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}). With
...
forms such as \emph{fearnes}, \emph{fearna}, and \emph{fearne}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
verb in the notation used here. Clark Hall and Bosworth-Toller record
\emph{flēogan} as the ordinary Old English strong verb, and Bright gives
the familiar paradigm \emph{flēag}, flugon, flogen with present
\emph{fleogeð} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898};
\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}). From
...
is the same lexeme in the accent notation used here. Clark Hall and
Bosworth-Toller both record \emph{gang} as the noun `going, journey,
way', and Bright's glossary gives \emph{gong (gang), m., path, course}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
verb \emph{gangan} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 159}).
...
2014}). Campbell gives \emph{gefan (W-S giefan)} among examples of
...
\emph{giefan} (\citeproc{ref-Campbell1959}{Campbell 1959};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
gives \emph{gold} (\citeproc{ref-Campbell1959}{Campbell 1959};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 42}). Ringe and
Taylor note that the medial stop can be understood either as alternation
\emph{*gulþa-} / \emph{*gulda-} or as the ordinary West Germanic change
\emph{*lþ} \textgreater{} ld; both routes lead to the same Old English
consonantism (\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014,
42}).
...
Hall 1960}). From \emph{*grábaną}, Anglo-Frisian brightening first gives
...
here (\citeproc{ref-ClarkHall1960}{Clark Hall 1960}).
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Bosworth-Toller
and Clark Hall record \emph{hærfest}, with \emph{herfest} as a variant
in the lexical tradition (\citeproc{ref-BosworthToller1898}{Bosworth and
Toller 1898}; \citeproc{ref-ClarkHall1960}{Clark Hall 1960}). From
\emph{*xárbistuz}, Anglo-Frisian brightening, breaking, and i-mutation
produce a \emph{hierbist-} stage, and later lowering of unstressed
medial \emph{i} to \emph{e} gives \emph{hierfest}.
...
\emph{*xélmaz}, loss of final \emph{z} and later loss of the short final
vowel yield \emph{helm}.
...
this input (\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}). Clark
Hall and Bosworth-Toller record \emph{helpan} as the verbal headword `to
help' (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 542}). From
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Bright gives the
ordinary strong-verb citation form and principal parts \emph{healdan,
heold, heoldon, healden} (\citeproc{ref-BrightCassidyRingler1971}{Bright
1971}). From \emph{*xáldaną}, Anglo-Frisian brightening first yields a
...
form used in the derivation here. Clark Hall, Bosworth-Toller, and
Bright all record \emph{horn} as the ordinary Old English noun
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 108};
\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}). From
...
and Taylor 2014}; \citeproc{ref-Kroonen2013}{Kroonen 2013, 363}). Clark
Hall and Bosworth-Toller both record \emph{lædan} / \emph{lǣdan} as the
ordinary Old English verb `to lead, guide, conduct'
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
1966}). Clark Hall and Bosworth-Toller record \emph{hlid} as the noun
`lid, cover, door, gate' (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 563}). The
selected input already represents the later Germanic \emph{hliđ-} stage
used for the derivation here.
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Clark Hall and
Bosworth-Toller preserve the verb family under spellings such as
...
Comparison note. Syncopated \emph{meolc} and Anglian \emph{milc} belong
to the competing leveled tradition associated with oblique forms,
whereas \emph{meoloc / meoluc} preserves the fuller nominal shape
(\citeproc{ref-Campbell1959}{Campbell 1959};
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
2003}; \citeproc{ref-Fulk2018}{Fulk 2018}). Clark Hall and
Bosworth-Toller record \emph{nett} as the noun, and Campbell notes that
final geminates are often graphically simplified in Old English spelling
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 29};
\citeproc{ref-Campbell1959}{Campbell 1959}). From \emph{*nátją}, West
Germanic j-gemination first gives \emph{*náttją}.
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014};
\citeproc{ref-Orel2003}{Orel 2003}). Clark Hall records \emph{mare}
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014};
\citeproc{ref-Orel2003}{Orel 2003}). Clark Hall records \emph{scēap}
with spelling variation, and Campbell likewise lists West Saxon
\emph{scéap} among the palatal-diphthongized forms
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-Campbell1959}{Campbell 1959}). From \emph{*skíllingaz},
loss of final \emph{-az} yields \emph{*skílling}.
...
\emph{slēpen} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
form is the West Saxon citation form \emph{smierwan}. From
...
used here for that same verbal lexeme. Clark Hall keeps noun
...
Hall 1960}; \citeproc{ref-SieversBrunner1965}{Sievers 1965}). From
...
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960}). As a heavy-stem Class I
weak verb, \emph{*stéllijaną} undergoes the expected syncope and
...
gs. sumeres, ds. sumera, sumere}, and Bright likewise lists \emph{sumor
(sumer)} with genitive \emph{sumeres}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BrightCassidyRingler1971}{Bright 1971, 440}). From
\emph{*súmaraz}, loss of final \emph{-az} is followed by fronting and
merger in the unstressed second syllable, yielding \emph{sumer}.

Form note. Old English also has \emph{sumor} as a common headword
spelling. The selected form here is \emph{sumer}, and
\emph{sumeres/sumere} show that the \emph{e}-vocalism was also real in
Old English (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
the noun headword (\citeproc{ref-ClarkHall1960}{Clark Hall 1960}). From
\emph{*swálwōn}, brightening yields \emph{*swælw-}, and breaking before
\emph{lw} gives \emph{*swealw-}.
...
\emph{swaluwe} or \emph{swalewan} (\citeproc{ref-ClarkHall1960}{Clark
Hall 1960}; \citeproc{ref-Campbell1959}{Campbell 1959}).
...
form. Clark Hall records \emph{swin (y)} as the ordinary noun headword
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960}). From selected input
\emph{*swḯną}, loss of the final nasal vowel yields \emph{swīn}.

Source note. The selected input writes stressed long \emph{ī} as
\emph{*ḯ}, so comparative \emph{*swī́ną} and derivational \emph{*swḯną}
...
comparative family. Bright lists \emph{þorn}, m., and Clark Hall
likewise treats \emph{þorn} as the ordinary noun headword
(\citeproc{ref-BrightCassidyRingler1971}{Bright 1971};
\citeproc{ref-ClarkHall1960}{Clark Hall 1960}). The inherited stem shows
regular lowering of \emph{u} to \emph{o} before \emph{r}, and final loss
yields \emph{þorn}.
...
separate. Bright records \emph{tīd} with singular \emph{tīde} and plural
...
1971}; \citeproc{ref-ClarkHall1960}{Clark Hall 1960, 309}). From
\emph{*tḯdiz}, final \emph{z} is lost and the high final vowel drops,
leaving \emph{tīd}. The note matters only because English \emph{tide}
can pull in the separate weak verb \emph{tīdan}; the noun targeted here
is \emph{tīd}.
...
\citeproc{ref-Hogg1992}{Hogg 1992}). English \emph{warp} also points to
related \emph{wearp} material. The selected form here is the infinitive
\emph{weorpan}.
...
heads the verb as \emph{wascan}, while Sievers-Brunner also notes the
variant \emph{wæscan} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}). Clark Hall gives
\emph{weaxan} as the verb headword and separately records bare
\emph{wax} as a preterite form; Bright likewise treats \emph{weaxan} as
the infinitive (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
\citeproc{ref-BrightCassidyRingler1971}{Bright 1971}). From
