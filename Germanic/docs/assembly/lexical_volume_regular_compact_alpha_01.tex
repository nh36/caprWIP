...
a notation that keeps the stressed long vowel explicit. Campbell treats
the West Saxon lowering of inherited long \emph{ē} as part of the
broader vowel history (\citeproc{ref-Campbell1959}{Campbell 1959}).
Brunner gives the contrast explicitly as West Saxon \emph{dǣd} beside
non-West-Saxon \emph{dēd} (\citeproc{ref-SieversBrunner1965}{Sievers
1965, sect. 98}). From inherited \emph{*dēdiz}, loss of final \emph{-z}
and the West Saxon lowering of stressed long \emph{ē} yield \emph{dǣd};
Anglian \emph{dēd} preserves the non-West-Saxon outcome
