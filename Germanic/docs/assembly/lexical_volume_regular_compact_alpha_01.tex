...
sundrian (\citeproc{ref-Orel2003}{Orel 2003, 426}). Kluge-Seebold aligns
the cognate set with German \emph{sondern} and OE \emph{gesundrian}, so
this entry belongs with the Class II verb, not the adverb
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 533};
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 577}). Campbell, Hogg, and
Ringe and Taylor use the same word as the standard contrast between
singular palatal \emph{weġ} and inflected \emph{wegas/wegum}
(\citeproc{ref-Campbell1959}{Campbell 1959};
...
\citeproc{ref-Orel2003}{Orel 2003, 492};
...
2013, 587}). Later handbook discussion keeps the dental original from
PIE \emph{*wendh-}, not a Verner alternant (\citeproc{ref-Fulk2018}{Fulk
...
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 335};
...
\emph{*lappōn}, and Kluge-Seebold cites West Germanic \emph{lappa} forms
alongside Old English \emph{læppa} (\citeproc{ref-Orel2003}{Orel 2003,
236}; \citeproc{ref-KlugeSeebold2011}{Kluge 2011}). The selected input
...
subsequent Old English vowel developments lead to \emph{hliehhan}
(\citeproc{ref-Fulk2018}{Fulk 2018}). Ringe and Taylor discuss the
broken vowel of the Old English form as part of this same history, with
possible support from the related noun \emph{hleahtor}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
compensatory lengthening (\citeproc{ref-Crist2002}{Crist 2002};
\citeproc{ref-Kroonen2013}{Kroonen 2013, 410};
\citeproc{ref-Fulk2018}{Fulk 2018, 69}), Orel keeps a doublet analysis
(\citeproc{ref-Orel2003}{Orel 2003, 311}), and Kilday instead argues
that West Saxon \emph{mēd} is a Saxono-Frisian loan
