...
consonant (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 407}). The
subsequent Old English vowel developments lead to \emph{hliehhan}. Ringe
and Taylor discuss the broken vowel of the Old English form as part of
this same history, with possible support from the related noun
\emph{hleahtor} (\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014}).
...
\emph{funden} is not the cleanest inherited comparison. Luick and
Brunner treat the better-known nominative participial forms as
...
later lowering of unstressed \emph{u}
(\citeproc{ref-Campbell1959}{Campbell 1959}). Back mutation then yields
\emph{heo-} before the labial plus back-vowel sequence, and loss of the
final high vowel gives \emph{heofon}.
