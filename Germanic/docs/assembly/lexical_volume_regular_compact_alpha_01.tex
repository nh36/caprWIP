...
strong verb in the notation used here. Clark Hall and Bosworth-Toller
record \emph{flēogan} as the ordinary Old English strong verb, and
Bright gives the familiar paradigm \emph{flēag}, flugon, flogen with
present \emph{fleogeð} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960};
...
2003}; \citeproc{ref-Fulk2018}{Fulk 2018, sect. 6.15}). Clark Hall and
...
\citeproc{ref-Campbell1959}{Campbell 1959, sect. 66}). From
\emph{*nátją}, West Germanic j-gemination first gives \emph{*náttją}.
...
sect. 66}; \citeproc{ref-Orel2003}{Orel 2003}).
