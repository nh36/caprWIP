...
headwords (\citeproc{ref-ClarkHall1960}{Clark Hall 1960}).
...
comparison form in this entry is therefore the class-I verb
...
\emph{*nusō} (\citeproc{ref-Campbell1959}{Campbell 1959}).
...
the OE chronology directly as \emph{stebn} \textgreater{} \emph{stefn}
...
Sievers-Brunner likewise cites \emph{man mannes} and explains that
word-final simplification underlies forms such as \emph{man} beside
inflected \emph{monnes} (\citeproc{ref-SieversBrunner1965}{Sievers
1965}). Clark Hall keeps the dictionary headword under \emph{mann}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960}).
...
\emph{leornian} from a learn-family base of the \emph{*lizn-} type, and
...
3rd edn. Edited by Frederic G. Cassidy and Richard N. Ringler. {New
York: Holt, Rinehart and Winston}.

\bibitem[\citeproctext]{ref-Bulbring1902}
Bülbring, Karl D. 1902. \emph{Altenglisches Elementarbuch}. {Heidelberg:
Winter}.

\bibitem[\citeproctext]{ref-Campbell1959}
Campbell, Alistair. 1959. \emph{Old {English} Grammar}. {Oxford:
Clarendon Press}.
...
Languages}. Vol. 3. Studies in Germanic Linguistics. {Amsterdam and
...
Sprache}. 25th edn. Edited by Elmar Seebold. {Berlin and Boston: de
Gruyter}.
...
Vol. 11. Leiden Indo-European Etymological Dictionary Series. {Leiden
and Boston: Brill}.
