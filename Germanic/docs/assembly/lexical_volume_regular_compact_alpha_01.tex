...
Regular entries use the compact book-prose layer, while the remaining
derivation classes retain their fuller entry prose. Each entry keeps a
derivational summary and a boxed trace divided between Earlier Germanic
and Old English developments.
...
72}; \citeproc{ref-ClarkHall1960}{Clark Hall 1960, 19}). The form
followed here, \emph{*bákaną}, represents the same weak verb in the
accent notation used here. From \emph{*bákaną}, Anglo-Frisian
brightening first gives \emph{*bækaną}. A-restoration before single
\emph{k} returns the stem vowel to \emph{a}, and later weak-tail
reductions yield \emph{bacan}.
...
\emph{bēce} (\citeproc{ref-Kroonen2013}{Kroonen 2013, 81}). The form
followed here, \emph{*bōkō}, is the nominative-singular shape of that
family. The form compared here is nominative \emph{bōc}; \emph{bēċe}
belongs to the same paradigm but is not the citation form used for this
derivation. From \emph{*bōkō}, final long \emph{ō} raises in Northwest
Germanic, and high-vowel apocope yields \emph{bōc}.
...
form followed here, \emph{*bḗrō}, is the same noun in the accent
notation used here. Clark Hall and Bosworth-Toller give \emph{bær}, and
Kroonen also records \emph{bar}. The normalized form \emph{bǣr} marks
the long vowel explicitly. From \emph{*bḗrō}, final long \emph{ō}
raises, long \emph{ē} lowers to \emph{ǣ}, and apocope yields \emph{bǣr}.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 122}). The form followed here,
\emph{*búrdiz}, is the nominative-style form that stands behind that
stem label. Clark Hall and Bosworth-Toller both attest simplex
\emph{byrd} as an Old English noun meaning `birth'
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 70};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 125}). From
\emph{*búrdiz}, loss of final \emph{z} gives \emph{*búrdi}.
...
broader derivational setting (\citeproc{ref-HoggPhonology1992}{Hogg 1992, 357}).
...
\emph{bān}. Clark Hall records \emph{bān} as the ordinary Old English
noun (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 44}). West Germanic
...
\citeproc{ref-Fulk2018}{Fulk 2018, 223}). The form compared here is
neuter \emph{bū}. Campbell and Brunner treat stressed monosyllabic
\emph{ō \textgreater{} ū} as a regular development in forms of this
type, and \emph{bū} belongs to that set
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 78}). Ringe and Taylor give
the plural development directly as northwest Germanic \emph{*brokiz}
\textgreater{} \emph{*breeci} \textgreater{} OE \emph{bréc}
...
71}; \citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 27}). The
...
\emph{Fell} (\citeproc{ref-Kroonen2013}{Kroonen 2013, 135}). The form
followed here, \emph{*féllą}, is the derivable singular form of that
same inherited noun. Clark Hall records \emph{fell} as the noun `fell,
skin, hide' (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 115}).
...
\emph{*fárn}; Anglo-Frisian brightening then yields \emph{*færn}
(\citeproc{ref-Fulk2018}{Fulk 2018, sect. 4.12}), and breaking before
\emph{r} plus consonant gives \emph{fearn}
...
324}). The form followed here, \emph{*fléuganą}, represents that
inherited strong verb in the notation used here. Clark Hall likewise
records \emph{flēogan} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960,
106}). Bright gives the familiar paradigm \emph{flēag}, flugon, flogen
with present \emph{fleogeð}
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 374};
\citeproc{ref-Orel2003}{Orel 2003, 282}). The inherited verbal base is
...
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 113};
...
(\citeproc{ref-Orel2003}{Orel 2003, 164}). The form followed here,
\emph{*gángaz}, is the same lexeme in the accent notation used here.
Bosworth-Toller records \emph{gang} as the noun `going, journey, way'
...
and Taylor 2014, 230}). Campbell gives \emph{gefan} (W-S \emph{giefan})
among examples of initial palatalization, and Clark Hall records the
verb under plain \emph{giefan} with forms such as \emph{geaf} and
\emph{giefen} (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 428};
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 134}). From
\emph{*gébaną}, initial \emph{g} palatalizes before \emph{e}; West Saxon
palatal diphthongization then yields \emph{ie}, and later tail reduction
gives \emph{giefan} (\citeproc{ref-Campbell1959}{Campbell 1959, sect.
185}; \citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 230}).
...
Ringe and Taylor cite the noun as \emph{*gulþa-} / \emph{*gulda-}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 42}). Kroonen
gives the same pair (\citeproc{ref-Kroonen2013}{Kroonen 2013, 194}). The
form followed here, \emph{*gúlθą}, preserves the older consonantal form
...
noun (\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 121};
...
(\citeproc{ref-Campbell1959}{Campbell 1959, 61}). Clark Hall records
\emph{grafan} as the verb `to dig, grave' and separately records noun
\emph{græf} `grave, trench' (\citeproc{ref-ClarkHall1960}{Clark Hall
1960, 153}). From \emph{*grábaną}, Anglo-Frisian brightening first gives
a fronted stem vowel.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 260}). The form followed here,
\emph{*xḗrą}, represents that same long-ē stem in the present
derivation. Clark Hall and Bosworth-Toller record \emph{hær} /
\emph{hǣr} as the ordinary Old English noun `hair'
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 158};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 510}). From
\emph{*xḗrą}, Northwest Germanic lowering gives a long front vowel, and
later loss of the final nasal leaves the Old English form \emph{hǣr}.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 260};
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 158}).
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 141}). Clark Hall
records \emph{hærfest}, with \emph{herfest} as a variant in the lexical
tradition (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 158};
...
Source note. The Old English form here, \emph{hierfest}, represents the
...
chiefly \emph{hærfest} / herfest, commonly treated as non-West-Saxon or
...
The derivational input models a palatal \emph{*-gj-} noun. West Germanic
j-gemination yields the geminate stop in this environment
(\citeproc{ref-Campbell1959}{Campbell 1959, sect. 407}). Bosworth-Toller
records the noun under the standard spelling \emph{hecg}
(\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 495}),
while Clark Hall preserves the related lexicographic material under
\emph{hege} and adjacent hedge-family forms
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 152}). From
\emph{*xágjaz}, later Old English palatalization and loss of final
\emph{j} produce the palatal-geminate outcome \emph{heġġ}.

Form note. Standard dictionary spelling is \emph{heċġ} or \emph{hecg}.
Normalized \emph{heġġ} is the form used here, while the ordinary
lexicographic forms remain the main Old English citation evidence
(\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 495};
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 152}).
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 259}). The form followed here,
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 266}). The form followed here,
...
Dialect note. West Saxon \emph{healdan} is the form used here. Anglian
and Mercian \emph{haldan} are genuine non-West-Saxon doublets rather
than corrections to that choice (\citeproc{ref-Campbell1959}{Campbell
1959, sect. 144}; \citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014,
199}).
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 259};
\citeproc{ref-Orel2003}{Orel 2003, 234}). The form followed here,
...
\emph{*xúrną} as the derivational form used here
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 259};
...
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 612}). The
form compared here is the ordinary infinitive citation form. From
...
distinct. The Old English form here, \emph{liornian}, therefore
represents the Northumbrian regular form.
...
563}). The derivational input already represents the later Germanic
...
preserves the verb family under spellings such as \emph{liehtan},
\emph{lihtan}, and \emph{līhtan}, distinct from the related noun
\emph{lēoht} and adjective \emph{leoht/liht}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 204}). From
...
form followed here, \emph{*líndō}, is the citation-form noun used here.
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 312}). The form
compared here is nominative \emph{mōder}. From \emph{*mōdēr}, regular
suffixal development yields that form.
...
maran}, and variant \emph{mere} (\citeproc{ref-RingeTaylor2014}{Ringe
and Taylor 2014, 192}). Orel preserves the same comparative lemma though
with a different Old English headword tradition
(\citeproc{ref-Orel2003}{Orel 2003, 262}). Clark Hall records
\emph{mare} `nightmare, monster' and also preserves related variant
forms \emph{mera / mere} (\citeproc{ref-ClarkHall1960}{Clark Hall 1960,
213}). The selected simplex input \emph{*márōn} regularly gives
\emph{mare} after brightening, A-restoration before the n-stem ending,
and later reduction of the final vowel.
...
\citeproc{ref-Kroonen2013}{Kroonen 2013, 290}). Clark Hall records
\emph{rocc} as an over-garment or tunic and preserves compounds such as
\emph{bisceoprocc} and \emph{breóstrocc}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 259}). With
\emph{*rúkkaz} as the derivational input, Northwest Germanic u-lowering
...
\citeproc{ref-Campbell1959}{Campbell 1959, sect. 185}). From
\emph{*skḗpą}, Northwest Germanic lowering gives \emph{*skǣpą}; after
apocope and palatalization the West Saxon branch diphthongizes to
\emph{sċēap}.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 482}), while Orel likewise
gives OE \emph{scilling} among the reflexes
(\citeproc{ref-Orel2003}{Orel 2003, 377}). The form followed here,
...
etymological background of the cognate set
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 482}). The form followed here,
...
\citeproc{ref-HoggPhonology1992}{Hogg 1992, 236}).
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 493};
\citeproc{ref-Fulk2018}{Fulk 2018, 120}). The form followed here,
\emph{*slḗpaną}, is the infinitive-style form used here for that
inherited sleep-verb. Clark Hall gives \emph{slæpan} with preterite
\emph{slēp}, \emph{slēap}, and Bright likewise lists \emph{slæpan}
\emph{(slāpan)}, \emph{slēp} \emph{slēpon} \emph{slēpen}
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 458}). Ringe and Taylor
instead cite a later-stage \emph{*smirwijana}, from which they derive
West Saxon \emph{smierwan}, Mercian \emph{smirwan}, and Northumbrian
\emph{smiriga} (\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014,
198, 263}). The form compared here is the West Saxon citation form
\emph{smierwan}. From \emph{*smérwijaną}, breaking before \emph{r +
...
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 263};
...
2013, 505}). The form followed here, \emph{*spánnaną}, is the
infinitive-style form used here for that same verbal lexeme. Clark Hall
keeps noun \emph{spann} and verb \emph{spannan} separate, and Brunner
likewise records \emph{sponnan, spannan stv.}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 286};
\citeproc{ref-SieversBrunner1965}{Sievers 1965, sects 392, 396}). From
...
\citeproc{ref-Orel2003}{Orel 2003, 362}). The form followed here,
...
\citeproc{ref-Orel2003}{Orel 2003, 362}).
...
The form followed here, \emph{*stéllijaną}, represents the verbal
j-formation used for the OE row. Kluge and Seebold keep the wider West
Germanic family of adjective \emph{still} and verb \emph{stillen} in
view (\citeproc{ref-KlugeSeebold2011}{Kluge 2011, 885}). Clark Hall
gives \emph{stillan} as the verb and separately \emph{stille} as the
adjective (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 292}). As a
heavy-stem Class I weak verb, \emph{*stéllijaną} undergoes the expected
syncope and i-umlaut, and later loss of \emph{j} after a heavy stem
yields \emph{stillan}.
...
\citeproc{ref-KlugeSeebold2011}{Kluge 2011, 886}).
...
sundrian (\citeproc{ref-Orel2003}{Orel 2003, 426}). Clark Hall keeps
\emph{sundrian} and \emph{syndrian} separate from adverbial
\emph{sundor} and preserves the prefixed verbal family \emph{ā-sundrian}
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 296}). From
...
\emph{sundrian} (\citeproc{ref-Orel2003}{Orel 2003, 426};
...
Source note. The derivational input writes stressed long \emph{ī} as
...
Kroonen gives the verb as \emph{*þankjan-} `to think'
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 533}). The noun \emph{*þankaz}
belongs only to the wider derivational background. Bosworth-Toller
preserves the verb under \emph{þencan}/\emph{geþencan}, and the citation
form here is the ordinary infinitive \emph{þenċan}
(\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 442}). From
...
\citeproc{ref-HoggPhonology1992}{Hogg 1992, sect. 3.4.2.4}).
...
\citeproc{ref-Orel2003}{Orel 2003, 430}). The form followed here,
...
`sign, token' (\citeproc{ref-Kroonen2013}{Kroonen 2013, 506};
\citeproc{ref-Orel2003}{Orel 2003, 438}). The form followed here,
\emph{*táikną}, is the simple citation-form noun used for the
derivation. Campbell preserves unbroken \emph{tācn} and oblique
\emph{tācnes} (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 574}),
and also records the later broken form \emph{tācen}
(\citeproc{ref-Campbell1959}{Campbell 1959, sect. 365}). Sievers-Brunner
likewise preserves both unbroken and broken shapes
(\citeproc{ref-SieversBrunner1965}{Sievers 1965, sect. 155}).
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 566};
\citeproc{ref-Orel2003}{Orel 2003, 452}). The form followed here,
...
village, town' (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 356}). The
inherited long \emph{ū} is preserved, and loss of the final nasal vowel
yields \emph{tūn} regularly (\citeproc{ref-SieversBrunner1965}{Sievers
1965, sect. 71}).
...
examples (\citeproc{ref-Campbell1959}{Campbell 1959, sect. 744};
...
Ringe and Taylor give preterite \emph{*warp}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 195}) and
infinitive \emph{*werpana} (\citeproc{ref-RingeTaylor2014}{Ringe and
Taylor 2014, 197}). The derivational input here is the verbal form
\emph{*wérpaną}. Clark Hall records \emph{weorpan} as the strong verb
headword and separately lists \emph{wearp} as both noun and preterite.
...
\citeproc{ref-HoggPhonology1992}{Hogg 1992, sect. 3.4.2.2}). English \emph{warp}
also points to related \emph{wearp} material. The form compared here is
the infinitive \emph{weorpan}.
...
(\citeproc{ref-SieversBrunner1965}{Sievers 1965, sect. 392}). From
\emph{*wáskaną}, brightening gives \emph{*wæskaną}.
...
infinitive develops regularly to \emph{weaxan}. The form compared here
is the infinitive \emph{weaxan}. Noun \emph{weax} and preterite
wax/\emph{wēox} belong to different lexical or paradigm slots.
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 577}). Ringe and Taylor use
the same word as the standard contrast between singular palatal
\emph{weġ} and inflected \emph{wegas/wegum}
(\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 341}). The Old
English singular is the ordinary noun \emph{weg}, here normalized as
\emph{weġ} to show the palatal final. From \emph{*wégaz}, final
\emph{*z} is lost and the weak tail apocopates, leaving word-final
\emph{*g} after a front vowel.
...
\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 355}). The form compared
here \emph{wǣpn} represents the unbroken line from \emph{*wḗpną}.
...
\emph{*weljōn} (\citeproc{ref-Kroonen2013}{Kroonen 2013, 618};
\citeproc{ref-Orel2003}{Orel 2003, 492}). The selected derivational form
\emph{*wéljô} is the noun-side input used for this row. Clark Hall
...
form compared here is the noun \emph{willa} `will, wish'. Related verb
\emph{willan} belongs to a separate lexeme and should not be substituted
for the noun row (\citeproc{ref-Kroonen2013}{Kroonen 2013, 618};
...
2013, 587}). Clark Hall and Bosworth-Toller record \emph{windan} as the
verb headword (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 335};
\citeproc{ref-BosworthToller1898}{Bosworth and Toller 1898, 101}). The
form followed here, \emph{*wíndaną}, yields the regular infinitive
...
587}; \citeproc{ref-ClarkHall1960}{Clark Hall 1960, 335}).
...
(\citeproc{ref-Kroonen2013}{Kroonen 2013, 611}). The form followed here,
...
Hall 1960, 343}). \emph{*lþ} voices to \emph{ld}, Anglo-Frisian
brightening yields \emph{wæld-}, and breaking before the cluster gives
\emph{weald-}; apocope then yields \emph{weald}.

Dialect note. \emph{wald} survives as an Anglian-type variant in the
same family. The Old English form here is normalized \emph{weald}, not
the variant form (\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 343}).
...
\citeproc{ref-RingeTaylor2014}{Ringe and Taylor 2014, 220}). Clark Hall
records \emph{gearn (e) n.} `yarn, spun wool'
(\citeproc{ref-ClarkHall1960}{Clark Hall 1960, 145}). From
...
\emph{*garnăn} do not replace the derivational input \emph{*gárną}.
...
history (\citeproc{ref-HoggPhonology1992}{Hogg 1992, 95}).
...
1959, sect. 373}; \citeproc{ref-HoggPhonology1992}{Hogg 1992, sect. 3.3.1.3}).
