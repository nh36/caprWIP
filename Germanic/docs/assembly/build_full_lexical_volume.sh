...
assembled_md="${script_dir}/lexical_volume_alpha_01.md"
assembled_tex="${script_dir}/lexical_volume_alpha_01.tex"
assembled_pdf="${script_dir}/lexical_volume_alpha_01.pdf"
