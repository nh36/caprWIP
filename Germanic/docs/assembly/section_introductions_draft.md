# Section introductions draft

This file contains **draft scaffolding**, not final polished front matter. The
wording is intentionally mechanical so it can be used as a stable assembly
placeholder and revised later without reopening entry-level prose.
