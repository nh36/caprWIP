...
build_log="${script_dir}/sound_change_volume_alpha_01_build.log"
...
docker run --rm --platform "${platform}" --entrypoint /bin/sh \
  -v "${repo_root}":/data -w /data "${image}" -c "
    ...
    pandoc Germanic/docs/assembly/sound_change_volume_alpha_01.md \
      --standalone \
      ...
      --citeproc \
      -o Germanic/docs/assembly/sound_change_volume_alpha_01.tex
    pandoc Germanic/docs/assembly/sound_change_volume_alpha_01.md \
      --standalone \
      --from=markdown+raw_tex+citations \
      --metadata-file=Germanic/docs/assembly/full_volume_metadata.yaml \
      ...
      --citeproc \
      --pdf-engine=xelatex \
      -o Germanic/docs/assembly/sound_change_volume_alpha_01.pdf
  " 2>&1 | tee "${build_log}"

echo "Generated ${script_dir}/sound_change_volume_alpha_01.tex"
echo "Generated ${script_dir}/sound_change_volume_alpha_01.pdf"
