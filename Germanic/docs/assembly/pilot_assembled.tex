...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: Anglo Frisian
Brightening & \emph{*bækaną} \\
Northwest Germanic & {[}no change{]} & OE A Restoration &
\emph{*bakaną} \\
...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: OE Au Fronting &
\emph{*báeug} \\
Northwest Germanic & {[}no change{]} & OE Diphthong Leveling &
\emph{*bēag} \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: PWGmc Final Bare A
Loss & \emph{*kráft} \\
Northwest Germanic: PGmc Final Z Deletion & \emph{*kráfta} & Anglo
Frisian Brightening & \emph{*kræft} \\
\end{longtable}
}
...
Proto-West Germanic & {[}no change{]} & Old English: PWGmc Final Bare A
Loss & \emph{*fógl} \\
Northwest Germanic: NWGmc U Lowering & \emph{*fóglaz} & OE Epenthetic
Vowel & \emph{*fógol} \\
...
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: Anglo Frisian
Brightening & \emph{*θístilæs} \\
Northwest Germanic & {[}no change{]} & OE L Adjacent Syncope &
\emph{*θístlæs} \\
...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: OE Heavy Syllable
Nasal Apocope & \emph{*wǣpn} \\
Northwest Germanic: NWGmc Long E Lowering & \emph{*wǣpną} & & \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic: PWGmc J Gemination & \emph{*wélljô} & Old English:
OE I Umlaut & \emph{*willjô} \\
Northwest Germanic & {[}no change{]} & OE Unstressed Long Vowel
Shortening & \emph{*willja} \\
...
\bottomrule\noalign{}
\endlastfoot
Proto-West Germanic & {[}no change{]} & Old English: OE Diphthong
Leveling & \emph{*jéogūθ} \\
Northwest Germanic: OE Ws Palatal Glide & \emph{*jéugunθ} & OE
Unstressed Long Vowel Shortening & \emph{*jéoguθ} \\
