...
\bottomrule\noalign{}
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & Anglo Frisian Brightening: \emph{*bækaną} \\
\textbf{Northwest Germanic} & OE A Restoration: \emph{*bakaną} \\
{[}no change{]} & OE Heavy Syllable Nasal Apocope: \emph{*bakan} \\
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & OE Au Fronting: \emph{*báeug} \\
\textbf{Northwest Germanic} & OE Diphthong Leveling: \emph{*bēag} \\
{[}no change{]} & \\
\end{longtable}
}
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & PWGmc Final Bare A Loss: \emph{*kráft} \\
\textbf{Northwest Germanic} & Anglo Frisian Brightening:
\emph{*kræft} \\
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & PWGmc Final Bare A Loss: \emph{*fógl} \\
\textbf{Northwest Germanic} & OE Epenthetic Vowel: \emph{*fógol} \\
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & Anglo Frisian Brightening: \emph{*θístilæs} \\
\textbf{Northwest Germanic} & OE L Adjacent Syncope: \emph{*θístlæs} \\
{[}no change{]} & OE Unstressed AE Merger: \emph{*θístles} \\
\end{longtable}
}
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & OE Heavy Syllable Nasal Apocope: \emph{*wǣpn} \\
\textbf{Northwest Germanic} & \\
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
PWGmc J Gemination: \emph{*wélljô} & OE I Umlaut: \emph{*willjô} \\
\textbf{Northwest Germanic} & OE Unstressed Long Vowel Shortening:
\emph{*willja} \\
{[}no change{]} & OE J Loss After Heavy: \emph{*willa} \\
\end{longtable}
}
...
\endlastfoot
\textbf{West Germanic} & \textbf{Old English} \\
{[}no change{]} & OE Diphthong Leveling: \emph{*jéogūθ} \\
\textbf{Northwest Germanic} & OE Unstressed Long Vowel Shortening:
\emph{*jéoguθ} \\
